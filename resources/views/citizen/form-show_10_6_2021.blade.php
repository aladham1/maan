...
@section("content")
    <div class="row" style="" id="auth_circle_users">
        <div>
            ...
            @endif
            <button
                class="@if(!in_array(2,$auth_circle_user) && !in_array(5,$auth_circle_user) && in_array(3,$auth_circle_user)) {{'accordion1'}} @else {{'accordion'}} @endif ">
            ...
            <button
                class="@if(in_array(2,$auth_circle_user) || in_array(5,$auth_circle_user)) {{'accordion'}} @else {{'accordion1'}} @endif ">
                ثالثا: الحاجة للاستيضاح عن مضمون ال{{$form_type->find($type)->name}}
            </button>
            <div class="panel" id="explain_div">
                <br>
                @if(($item->need_clarification && in_array(2,$auth_circle_user))  || ($item->need_clarification && in_array(5,$auth_circle_user)))
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="optradio1"
                                               value="0" @if($item->need_clarification && $item->need_clarification == 0) {{"checked disabled"}} @elseif($item->need_clarification && $item->need_clarification == 1){{"disabled"}} @endif>
                                        لا
                                    </label>
                                </div>
                            </div>
                        ...
                        @if(!is_null($item->reprocessing))
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    @else
                                        <h4 style="color: red;">
                                            يوصي بإعادة معالجة ال{{$form_type->find($type)->name}} مع أخذ بعين الاعتبار
                                            التوصيات التالية
                                        </h4>
                                        <input class="form-control" value="{{$item->reprocessing_recommendations}}"
                                               readonly/>
                                    @endif
                                </div>
                        ...
                        <form id="update_clarification_form_modal" class="prodcedure_2">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 col-sm-offset-6">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optradio1" value="0">
                                                لا
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    ...
                                    <button onclick="location.reload();" class="btn btn-danger button">إلغاء الأمر
                                    </button>
                                </div>
                            </div>
                        </form>
                ...
                @if(in_array(5,$auth_circle_user) && $item->need_clarification && is_null($item->reprocessing))
            ...
            @if(!$item->reason_lack_clarification)
                    ...
                    @if(!($item->confirm_deleting ||  $item->deleted_at))
                                ...
                                <form id="update_category_form_modal">
                                    ...
                                    <div class="form-group row" id="updated_category_div">
                                        <div class="col-sm-2">
                                            ...
                                            <button onclick="location.reload();" class="btn btn-danger">إلغاء الأمر
                                            </button>
                                        </div>
                                        <div class="col-sm-10">
                        ...
                        @if(in_array(4,$auth_circle_user) && !$item->form_follow)
                            <button class="accordion hide_div">
                            ...
                            <div class="panel hide_div" id="rank_div">
                                ...
                                <form action="{{route('change_replay_status_feedback' , $item->id)}}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label for="sent_type" class="col-sm-4 col-form-label">الجهة المسؤولة عن
                                                تبليغ الرد
                                                (موظف الاتصال)</label>
                                            <?php $test = Auth::user()->account->account_projects->where('project_id', "!=", "1")->groupBy('rate')?>
                                    ...
                                    <div class="form-group row" id="follow_reason_not_div" style="display: none">
                                        <div class="col-md-12">
                                            ...
                                            <select id="follow_reason_not" name="follow_reason_not" class="form-control"
                                                ...
                                                <option value="أرقام التواصل الخاصة بمقدم الاقتراح/الشكوى غير صحيحة.">
                                                    أرقام
                        ...
                        @elseif($item->form_follow)
                            ...
                            <div class="panel hide_div" id="rank_div">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="sent_type" class="col-sm-4 col-form-label">الجهة المسؤولة عن تبليغ
                                            الرد
                                            (موظف الاتصال)</label>
                                        <input style="width: 65% !important;" type="text" class="form-control"
                                               name="replay_user_name" readonly
            ...
            {{-------------------------------------------------------}}
            @if(!in_array(2,$auth_circle_user) && !in_array(5,$auth_circle_user) && in_array(3,$auth_circle_user))
                    ...
                    <div class="panel hide_div" id="replies">
                        ...
                        @if(($item->response_type == 0 || $item->response_type == 1) && $item->form_response)
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    ...
                                    <select id="response_type_select" name="response_type" class="form-control"
                                            style="width: 50% !important;" readonly="">
                                        <option value="">اختر نوع</option>
                                        <option @if($item->response_type==0)selected @endif  value="0">يمكن الرد عليها
                                            مباشرة
                                        </option>
                                        <option @if($item->response_type==1)selected @endif  value="1">تتطلب إجراءات
                                            مطولة للرد عليها
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <select name="required_respond" class="form-control" style=" width: 50%;"
                                            ...
                                            <option
                                                @if($item->required_respond=="نقاش مع الجهات الشريكة/الممولة لمعالجتها")selected
                                                @endif value="نقاش مع الجهات الشريكة/الممولة لمعالجتها">نقاش مع الجهات
                                                الشريكة/الممولة لمعالجتها
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label for="sent_type" class="col-sm-4 col-form-label">صياغة الرد</label>
                                    <textarea name="response" rows="2" cols="78" style="border-radius: 10px;" readonly
                            ...
                            @if($item->form_response->old_response)
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="sent_type" class="col-sm-4 col-form-label">صياغة الرد المعدل بناءً
                                            على نتائج إجراءات المصادقة</label>
                                        <textarea name="response_after_confirmation" rows="2" cols="78"
                                                  style="border-radius: 10px;" readonly
                                                  disabled>{{$item->form_response->old_response}}</textarea>
                                    </div>
                    ...
                    @else
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input style="width: 65% !important;" type="text" class="form-control"
                                       id="replay_status"
                                       name="replay_status" value="{{$item->form_response->confirmation_date}}"
                                       readonly>
                            </div>
        ...
        @if(!in_array(2,$auth_circle_user) && !in_array(5,$auth_circle_user) && in_array(4,$auth_circle_user))
...
@section("content")
    ...
    <div class="row">
        <div class="col-md-12">
            <h4 style="color: red">عزيزي المواطن/ة في حال وجود أي استفسار أو اعتراض من طرفك حول محتوى الاقتراح أو الشكوى
                والرد عليه/ا يمكنك إعادة التواصل مع المركز على الرقم المجاني 1800900901</h4>
        </div>
    </div>
