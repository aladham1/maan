    ...
    <div class="container">
        ...
        <div class="panel panel-primary setup-content" id="step-1">
            ...
            <div class="panel-body">
                ...
                @if(in_array(3,$auth_circle_user) || in_array(4,$auth_circle_user))
                    @if(!is_null($item->need_clarification))
                            <div class="form-group row">
                                <div class="col-sm-6 col-sm-offset-6">
                                    <label for="sent_type" class="col-form-label">هل ال{{$form_type->find($type)->name}}
            ...
            <div class="panel-body">
                ...
                @else
                    ...
                    @if($item->form_response && !is_null($item->form_response->objection_response))
                        ...
                        <div class="form-group row">
                            <div class="col-sm-8" id="objection_response_div"
                                ...
                                <textarea name="old_response" rows="2" cols="78"
                                          style="border-radius: 10px; @if($item->form_response->old_response) readonly @endif" disabled readonly>@if($item->form_response->old_response) {{$item->form_response->old_response}}  @endif</textarea>
                        ...
                        <hr>
                        <button class="btn btn-primary nextBtn pull-right button" @if(count($auth_circle_user) == 1 && in_array(3,$auth_circle_user) && $item->form_response->confirmation_status == 2)disabled @endif>
                            التالي
                        </button>
    ...
    <script>
        ...
        $('#update_clarification_form_modal').submit(function (e) {
            ...
            $.post("/account/form/clarification_from_citizian/" + id, {
                ...
                var step = 1;
                if ($("input[name='optradio1']:checked").val() == 0 || $("input[name='optradio2']:checked").val()) {
                    step = 2;
                }
