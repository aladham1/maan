...
@section("content")
    <div class="row">
        ...
        @if($type == 1)
            <div class="col-md-12">
                <h4>الرجاء القيام بشرح الشكوى/ المشكلة التي تواجهها مع التأكيد على أنه سيتم التعامل مع المعلومات التي
                    ستقدمها بكل جدية وبسرية تامة.</h4>
            </div>
        @else
            <div class="col-md-12">
                <h4> نسعد باستقبال مقترحاتكم بما يساهم في تحسين الخدمات التي يقدمها المركز، يرجى التفضل بتوضيح
                    مقترحاتكم.
                </h4>
            </div>
        @endif
                        ...
                        <form method="POST" id="form1" class="form-horizontal" action="/citizen/savenew" autocomplete="off">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control {{($errors->first('mobile') ? " form-error" : "")}}"  type="tel" maxlength="10" onchange="phonenumber($('#mobile').val(),1)" value="{{old("mobile")}}" id="mobile" name="mobile" autocomplete="mobile">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control {{($errors->first('mobile2') ? " form-error" : "")}}" type="tel"
                                           value="{{old("mobile2")}}" maxlength="10" id="mobile2" name="mobile2" onchange="phonenumber($('#mobile2').val(),2)" autocomplete="mobile2">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control {{($errors->first('city') ? " form-error" : "")}}"
                                           type="text" value="{{old("city")}}" id="city" name="city" autocomplete="city">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control {{($errors->first('street') ? " form-error" : "")}}"
                                           type="text" value="{{old("street")}}" id="street" name="street" autocomplete="street">
                        ...
                        <form id="form2" action="/forms/formsavenew" method="POST"
                            ...
                            @if(auth()->user())
                                ...
                                <div class="form-group row" id="type_of_box_div" style="display: none !important;">
                                    <div class="col-sm-4">
                                        <label for="box_place" class="col-sm-6 col-form-label">مكان تواجد
                                            الصندوق</label>
                                    ...
                                    <div class="col-sm-4">
                                        <label for="number_of_open_box" class="col-sm-6 col-form-label">رقم اجتماع فتح
                                            الصندوق</label>
                                    ...
                                    <div class="col-sm-4">
                                        <label for="date_open_box" class="col-sm-6 col-form-label">تاريخ فتح الصندوق</label>
                                        <input type="text" class="form-control datepicker" name="date_open_box"
                                ...
                                <div class="form-group row" id="type_of_followup_visit_div"
                                    ...
                                    <div class="col-sm-6">
                                        <label for="type_of_followup_visit" class="col-sm-4 col-form-label">نوع زيارة
                                            المتابعة</label>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label for="datee" class="col-sm-4 col-form-label">تاريخ
                                            تقديم {{$form_type->find($type)->name}}</label>
                                        <input type="text" class="form-control datepicker" name="datee"
                                               value="{{old('datee')}}"/>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label for="title"
                                           class="col-sm-4 col-form-label">موضوع ال{{$form_type->find($type)->name}}</label>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label for="content"
                                           class="col-sm-4 col-form-label">محتوى ال{{$form_type->find($type)->name}}</label>
                                    <textarea id="content"
        ...
        <div class="form-group row" align="left">
            <div class="col-sm-12">
                <button type="submit" id="submitBtn" class="wow bounceIn btn btn-info btn-md"
                        style="width: 20%; background-color:#BE2D45;border:0;">
