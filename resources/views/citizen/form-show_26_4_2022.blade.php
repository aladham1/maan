                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered"
                                                        ...
                                                        <tr class="showdateciz">
                                                            ...
                                                            <td colspan="2">@if($item->hide_data == 1 || $item->private_account != Auth::user()->id){{'_'}}@else {{$item->citizen->id}}@endif</td>
                                                            <td colspan="2">الاسم رباعي:</td>
                                                            <td colspan="2">@if($item->hide_data == 1 || $item->private_account != Auth::user()->id){{'_'}}@else{{$item->citizen->first_name ." ".$item->citizen->father_name." ".$item->citizen->last_name}}@endif</td>
                                                            <td colspan="2">رقم الهوية/جواز السفر:</td>
                                                            <td colspan="2">@if($item->hide_data == 1 || $item->private_account != Auth::user()->id){{'_'}}@else{{$item->citizen->id_number}}@endif</td>
                                                        </tr>

                                                        <tr class="showdateciz">
                                                            <td colspan="2">رقم التواصل (1):</td>
                                                            <td colspan="2">@if($item->hide_data == 1 || $item->private_account != Auth::user()->id){{'_'}}@else{{$item->citizen->mobile}}@endif</td>
                                                            <td colspan="2">رقم التواصل (2):</td>
                                                            <td colspan="2">@if($item->hide_data == 1 || $item->private_account != Auth::user()->id){{'_'}}@else{{$item->citizen->mobile2}}@endif</td>
                                                        ...
                                                        <tr class="showdateciz">
                                                            ...
                                                            <td colspan="2">فئة مقدم {{$form_type->find($type)->name}}
                                                                :
                                                            </td>
                                                            <?php
                                                            $project_arr = array();
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if($item->hide_data == 1 || $item->private_account != Auth::user()->id)
                                                                <td colspan="2">_</td> @else
                                                    ...
                                                    <table class="table table-striped table-bordered"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mo" colspan="2">تاريخ تسجيل
                                                                ال{{$form_type->find($type)->name}} علي النظام:
                                                            </td>
                                                            <td colspan="2">{{date('d-m-Y', strtotime( $item->created_at))}}</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if($item->old_category_id)
                                                                <td class="mo" colspan="2">فئة
                                                                    ال{{$form_type->find($type)->name}} المعدلة بناءً
                                                                    على محتوى
                                                                    ال{{$form_type->find($type)->name}}:
                                                                </td>
                                                        ...
                                                        @if($item->reformulate_content)
                                                            <tr>
                                                                <td class="mo" colspan="2">محتوى
                                                                    ال{{$form_type->find($type)->name}} المعدل بناءً على
                                                                    نتيجة
                                                                    الاستيضاح:
                                                                </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="10">
                                                                ...
                                                                <a class="btn btn-xs btn-primary" data-toggle="modal"
                                                                   ...
                                                                   data-attr="{{ route('showfiles', $item->id) }}"
                                                                   title="اضغظ هنا">
                                                                    <i class="fa fa-eye"></i>
                                                                </a>
                                                                <?php }else{?>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary setup-content" id="step-1">
                                ...
                                <div class="panel-body">
                                    @if((in_array(2,$auth_circle_user) ||  (in_array(5,$auth_circle_user) && $item->follower_reprocessing == 1))&&
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-offset-6 col-sm-6">
                                                        <label for="sent_type" class="col-form-label">هل تم الاستيضاح عن
                                                            مضمون ال{{$form_type->find($type)->name}}؟</label>
                                                        <div class="col-sm-2">
...
&& (in_array(2,$auth_circle_user) || (in_array(5,$auth_circle_user) && $item->follower_reprocessing == 1)))  || (!is_null($item->need_clarification) && in_array(5,$auth_circle_user)))
                                            ...
                                            @if(!is_null($item->reprocessing))
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        @else
                                                            <div class="col-sm-4">
                                                                @if((in_array(2,$auth_circle_user)|| (in_array(5,$auth_circle_user) && $item->follower_reprocessing == 1)) && $item->reprocessing_form_id)
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-offset-6 col-sm-6">
                                                            <label for="sent_type" class="col-form-label">هل تم
                                                                الاستيضاح عن مضمون ال{{$form_type->find($type)->name}}
                                                                ؟</label>
                                                            <div class="col-sm-2">
                                                                <div class="form-check-inline">
                                                                    <label class="form-check-label">
                            ...
                            <div class="panel panel-primary setup-content" id="step-2">
                                ...
                                <div class="panel-body">
                                    @if((in_array(2,$auth_circle_user)|| (in_array(5,$auth_circle_user) && $item->follower_reprocessing == 1)) &&  !is_null($item->deleting) && $item->deleting == 0 && !$item->form_response)
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="form-check-inline">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input"
                                                                       name="optradio"
                                                                       value="0" @if($item->deleting == 0){{'checked'}}@endif>
                                                                لا
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    @elseif((in_array(2,$auth_circle_user)|| (in_array(5,$auth_circle_user) && $item->follower_reprocessing == 1)) &&  is_null($item->deleting))
                                        <form id="delete_form_modal">
                                            <input type="hidden" id="deleted_id" value="{{$item->id}}">
                                            <div class="form-group row">
                                                <div class="col-sm-6 col-sm-offset-6">
                                    ...
                                    @else
                                                    ...
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio"
                                                                   value="0"
                                                                   @if($item->deleting == 0){{'checked'}}@endif disabled>
                                                            لا
                                        ...
                                        @if($item->recommendations_for_deleting)
                                            <hr>
                                            <h4>
                                                فيما يلي التوصيات بخصوص حذف ال{{$form_type->find($type)->name}} من قبل
                                                الجهة الإدارية المسؤولة عن متابعة الجهة المختصة بمعالجة
                                                ال{{$form_type->find($type)->name}}</h4>
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td>التوصيات:</td>
                                                    <td>
                                                        {{$item->recommendations_for_deleting}}</td>
                                                </tr>
                                            </table>
                                            @if((in_array(2,$auth_circle_user)|| (in_array(5,$auth_circle_user) && $item->follower_reprocessing == 1)) && is_null($item->deleted_at))
                                                <div>
                                                ...
                                                <div class="form-group row" id="updated_category_div">
                                                    <div class="col-sm-12">
                                                        <label class="col-sm-4 col-form-label">فئة
                                                            ال{{$form_type->find($type)->name}} المعدلة بناءً على محتوى
                                                            ال{{$form_type->find($type)->name}}:</label>
                                                        @if($item->type == 1)
                                                    ...
                                                    <form action="{{route('change_replay_status_feedback' , $item->id)}}"
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select class="form-control" id="follow_form_status"
                                                                        ...
                                                                        <option value="1"
                                                                                @if(old('follow_form_status') == 1) selected @endif>
                                                                            تم تبليغ الرد
                                                                        </option>
                                                                        <option value="2"
                                                                                @if(old('follow_form_status') == 2) selected @endif >
                                                                            لم يتم تبليغ الرد
                                                                        </option>
                                                                    </select>
                                                                    {!! $errors->first('follow_form_status', '<p class="help-block" style="color:red;">:message</p>') !!}
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="{{ \App\Account::find($item->private_account)->full_name }}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row" id="follow_reason_not_div"
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    {!! $errors->first('follow_reason_not', '<p class="help-block" style="color:red;">:message</p>') !!}
                                                            ...
                                                            <div class="form-group row" id="feedback_div"
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <select id="evaluate" name="evaluate"
                                                                        ...
                                                                        <option value="1"
                                                                                @if(old('evaluate') == 1) selected @endif>راضي
                                                                            بشكل كبير
                                                                        </option>
                                                                        <option value="2"
                                                                                @if(old('evaluate') == 2) selected @endif>راضي
                                                                            بشكل متوسط
                                                                        </option>
                                                                        <option value="3"
                                                                                @if(old('evaluate') == 3) selected @endif>راضي
                                                                            بشكل ضعيف
                                                                        </option>
                                                                        <option value="4"
                                                                                @if(old('evaluate') == 4) selected @endif>غير
                                                                            راضي عن الرد
                                                                        </option>
                                                                    </select>
                                                                    {!! $errors->first('evaluate', '<p class="help-block" style="color:red;">:message</p>') !!}
                   ...
                   <textarea name="notes" rows="2" cols="78"
                             style="border-radius: 10px;"></textarea>
                                                                            ...
                                                                            {!! $errors->first('notes', '<p class="help-block" style="color:red;">:message</p>') !!}
                                                ...
                                                @else
                                                    ...
                                                    @if(in_array(5,$auth_circle_user) && !is_null($item->form_follow->follow_reason_not) & is_null($item->recommendations_for_follow_reason_not))
                                                    ...
                                                    @if((in_array(4,$auth_circle_user) || (in_array(5,$auth_circle_user) && $item->follower_reprocessing == 1))&& $item->recommendations_for_follow_reason_not && $item->form_follow->solve != 1)
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <label style="display: block;">التوصيات:</label>
                                                                @if(!is_null($item->confirm_follow_reason_not) && $item->confirm_follow_reason_not == 1)
                                                                    <input class="form-control"
                                                                           value="يوصي بإغلاق ال{{$form_type->find($type)->name}}"
                                                                           readonly/>
                                                                @else
                                                                    <div class="col-sm-4">
                                                                        @if(in_array(4,$auth_circle_user) && is_null($item->confirm_follow_reason_not))
                                                                            <div>
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <label>يوصي بإعادة تبيلغ الرد
                                                                            ...
                                                                            التوصيات التالية</label>
                                                                        <input class="form-control"
                                                                               value="{{$item->recommendations_for_follow_reason_not}}"
                                                                               readonly/>
                                                                    </div>
                                                                @endif
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label style="display: block">الجهة الإدارية المسؤولة عن متابعة
                                                                    الجهة المختصة بمعالجة
                                                                    ال{{$form_type->find($type)->name}}</label>
                                                                @if(is_null($item->confirm_follow_reason_not))
                                                                    <label> </label>
                                                                @endif
                                                                <input style="width: 75%;" class="form-control"
                                                                       value="{{$item->user_recommendations_for_follow_reason_not->full_name}}"
                                                                       readonly/>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select id="evaluate" name="evaluate"
                                                                        ...
                                                                        @if($item->form_follow->evaluate) disabled @endif>

                                                                    <option value="">اختر حالة تبليغ الرد</option>
                                                                    <option value="1"
                                                                            @if($item->form_follow->evaluate == 1) selected @endif>
                                                                        راضي
                                                                        بشكل كبير
                                                                    </option>
                                                                    <option value="2"
                                                                            @if($item->form_follow->evaluate == 2) selected @endif>
                                                                        راضي
                                                                        بشكل متوسط
                                                                    </option>
                                                                    <option value="3"
                                                                            @if($item->form_follow->evaluate == 3) selected @endif>
                                                                        راضي
                                                                        بشكل ضعيف
                                                                    </option>
                                                                    <option value="4"
                                                                            @if($item->form_follow->evaluate == 4) selected @endif>
                                                                        غير
                                                                        راضي عن الرد
                                                                    </option>
                                                                </select>
               ...
               <textarea name="notes" rows="2" cols="78" style="border-radius: 10px;"
                         disabled>{{$item->form_follow->notes}}</textarea>
                                                    ...
                                                    @if(in_array(5,$auth_circle_user) && $item->form_follow && $item->form_follow->evaluate == 4 &&  $item->confirm_evaluate_4 != 1)
                                                        <form id="khlkjj"
                                                              action="{{route('confirm_change_replay_status_feedback' , $item->id)}}"
                                                              method="POST">
                                                            @csrf
                                                            {{--                                                    --}}
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                {!! $errors->first('confirm_evaluate', '<p class="help-block" style="color:red;">:message</p>') !!}
                                                            </div>
                                                    ...
                                                    @if($item->form_follow && $item->form_follow->evaluate == 4 && $item->confirm_evaluate_4 == 1)
               ...
               <textarea name="notes" rows="2" cols="78" style="border-radius: 10px;"
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <select id="response_type_select" name="response_type"
                                                        ...
                                                        <option value="0" @if(old('response_type')==0)selected @endif>
                                                            يمكن الرد عليها مباشرة
                                                        </option>
                                                        <option value="1" @if(old('response_type')==1)selected @endif>
                                                            تتطلب إجراءات مطولة للرد عليها
                                                        </option>
                                                    </select>
                                                    {!! $errors->first('response_type', '<p class="help-block" style="color:red;">:message</p>') !!}
                                                </div>
                                                <div class="col-sm-6">
                                            ...
                                            <div id="replay_advanced" style="display: none">
                                                <div class="form-group row">
                                                    <div class="col-sm-4">
                                                        ...
                                                        {!! $errors->first('form_file', '<p class="help-block" style="color:red;">:message</p>') !!}
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        {!! $errors->first('form_data', '<p class="help-block" style="color:red;">:message</p>') !!}
                                                    </div>
                                                    <div class="col-sm-4">
                                                        ...
                                                        {!! $errors->first('required_respond', '<p class="help-block" style="color:red;display: inline-block;">:message</p>') !!}
                                                    </div>
                                                </div>
                ...
                <textarea name="response" rows="2" cols="110"
                          style="border-radius: 10px;"></textarea>
                                                ...
                                                <div class="col-md-12">
                                                    {!! $errors->first('response', '<p class="help-block" style="color:red;">:message</p>') !!}
                                                </div>
                                            </div>
            ...
            <textarea name="response" rows="2" cols="110"
                ...
                <textarea name="old_response" rows="2" cols="110"
                          ...
                          readonly>@if($item->form_response->old_response) {{$item->form_response->old_response}}  @endif</textarea>
                                        ...
                                        @if((in_array(3,$auth_circle_user)|| (in_array(5,$auth_circle_user) && $item->follower_reprocessing == 1)) && $item->form_response)
                                            @if($item->form_response && is_null($item->form_response->objection_response))
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <div class="form-check-inline">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" class="form-check-input"
                                                                                   name="objection_response"
                                                                                   value="0" @if( old('objection_response')== 0) {{"checked"}} @endif >
                                                                            لا
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-2">
                                                                    <div class="form-check-inline">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" class="form-check-input"
                                                                                   name="objection_response"
                                                                                   value="1" @if( old('objection_response')== 1) {{"checked"}} @endif>
                                                                            نعم
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {!! $errors->first('objection_response', '<p class="help-block" style="color:red;">:message</p>') !!}
                            ...
                            <textarea name="old_response" rows="2" cols="110"
                                      style="border-radius: 10px;"></textarea>
                                                            ...
                                                            {!! $errors->first('old_response', '<p class="help-block" style="color:red;">:message</p>') !!}
...
//location.reload();
        ...
        $('#confirm_follow_reason_not_modal').submit(function (e) {
            ...
            var inputValue = $("input[name='optradio15']:checked").val();
            if (inputValue == 1) {
                $.post("{{route('confirm_follow_reason_not')}}", {
                    "_token": "{{csrf_token()}}",
                    'id': id,
                }, function (data) {
                    window.location.href = '/account';
                ...
                $.post("{{route('confirm_follow_reason_not_reprocessing_recommendations')}}", {
                    "_token": "{{csrf_token()}}",
                    'id': id,
