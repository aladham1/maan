                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3 mb-10">
                                            ...
                                            <input
                                                ...
                                                type="text" value="{{old("first_name")}}" id="first_name"
                                                name="first_name"
                                                autocomplete="off">
                                        ...
                                        <div class="col-sm-3 mb-10">
                                            ...
                                            <input
                                                ...
                                                type="text" value="{{old("last_name")}}" id="last_name"
                                                name="last_name">
                                        ...
                                        <div class="col-sm-3 mb-10">
                                            ...
                                            <input
                                                ...
                                                readonly type="number" value="{{$id_number}}" id="id_number"
                                                name="id_number"
                                                autocomplete="off">
                                        ...
                                        <div class="col-sm-3 mb-10">
                                            ...
                                            <input
                                                ...
                                                type="text" value="{{old("city")}}" id="city" name="city"
                                                autocomplete="cityxx">
                                        ...
                                        <div class="col-sm-3 mb-10">
                                            ...
                                            <input
                                                ...
                                                type="text" value="{{old("street")}}" id="street" name="street"
                                        ...
                                        <div class="col-sm-3 mb-10">
                                            ...
                                            <input name="type_name"
                                                   value="@if($type=='0'){{'مستفيد'}}@else{{'غير مستفيد'}}@endif"
                                                   type="text"
