                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered"
                                            ...
                                            <tr class="showdateciz">
                                                ...
                                                <td colspan="2">@if($item->hide_data == 1){{'_'}}@else{{$item->citizen->first_name ." ".$item->citizen->father_name." ".$item->citizen->last_name}}@endif</td>
                                                <td colspan="2">رقم الهوية/جواز السفر:</td>
                                                <td colspan="2">@if($item->hide_data == 1){{'_'}}@else{{$item->citizen->id_number}}@endif</td>
                                            </tr>

                                            <tr class="showdateciz">
                                                <td colspan="2">رقم التواصل (1):</td>
                                                <td colspan="2">@if($item->hide_data == 1 ){{'_'}}@else{{$item->citizen->mobile}}@endif</td>
                                                <td colspan="2">رقم التواصل (2):</td>
                                                <td colspan="2">@if($item->hide_data == 1){{'_'}}@else{{$item->citizen->mobile2}}@endif</td>
                                            ...
                                            <tr>
                                                <td colspan="2">رقم طلب المشروع:</td>
                                                    ...
                                                    @if($item->project_id != 1)
                                                        ...
                                                        <td colspan="2">@if($item->citizen->citizen_projects()->where('project_id',$item->project_id)->first()){{$item->citizen->citizen_projects()->where('project_id',$item->project_id)->first()->project_request}}@else{{'-'}}@endif</td>
                                                    @else
                                                        <td colspan="2">_</td>
                                                    @endif
