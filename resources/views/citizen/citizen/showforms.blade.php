...
<div class="row">
        <div class="col-md-12">
                <h3 class="inner-h1 page-title wow bounceIn" style="padding-right: 0px;"> أهلاً بك عزيزي المواطن (XX) نتائج البحث </h3>
            </div>
                ...
                <div class="inner-card-body">
                    <div class="row pb-50">
                        <div class="col-lg-12 col-12 d-flex justify-content-between flex-column mt-1">
                            <div>
                                <h4 class="text-bold-500 mb-25">عزيزي المواطن يمكنك هنا الاطلاع على الاقتراحات والشكاوى التي تقدمت بها للمركز</h4>
                            </div>
                        </div>
	    ...
	    <div class="row">
	        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <tr style="background-color: #f9f9f9;font-weight: 600;border: 1px solid #ddd;color: #333;">
                                ...
                                <th style="text-align: center;color:#333;">الرقم المرجعي</th>
                                <th style="text-align: center;color:#333;">فئة مقدم الاقتراح/الشكوى</th>
                                <th style="text-align: center;color:#333;">اسم المشروع</th>
                                <th style="text-align: center;color:#333;">النوع</th>
                                <th style="text-align: center;color:#333;">فئة الاقتراح/الشكوى</th>
