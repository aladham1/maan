...
@section("content")
    <div style="" id="auth_circle_users">
        <section class="container-fluid login-wrap edit-wrap">
            <div class="row">
                <div class="col-md-12">
...
{{--                            @endif--}}
                            ...
                            @if($item->reprocessing_parent_form_id)
                                <a tar
                                   .get="_blank" class="btn btn-primary"
                    ...
                    <div class="panel" id="first_panel">
                        <div class="table-responsive" style="border: solid 1px;">
                            <table class="table table-hover table-striped table-bordered"
                                   style="width:100%;white-space:normal;font-weight: 600">
                                <tr class="showdateciz">
                                    <td>الرقم المرجعي:</td>
                                    <td style="color: #be2d45;">{{$item->citizen->id}}</td>
                                    <td>الاسم رباعي:</td>
                                    <td style="color: #be2d45;">{{$item->citizen->first_name ." ".$item->citizen->father_name." ".$item->citizen->last_name}}</td>
                                    <td>رقم الهوية/جواز السفر:</td>
                                    <td style="color: #be2d45;">{{$item->citizen->id_number}}</td>
                                </tr>

                                <tr class="showdateciz">
                                    <td>رقم التواصل (1):</td>
                                    <td style="color: #be2d45;">{{$item->citizen->mobile}}</td>
                                    <td>رقم التواصل (2):</td>
                                    <td style="color: #be2d45;">{{$item->citizen->mobile2}}</td>
                                    <td>المحافظة:</td>
                                    <td style="color: #be2d45;">{{$item->citizen->governorate}}</td>
                                </tr>

                                <tr class="showdateciz">
                                    <td>المنطقة :</td>
                                    <td colspan="2" style="color: #be2d45;">{{$item->citizen->city}}</td>
                                    <td>العنوان:</td>
                                    <td colspan="2" style="color: #be2d45;">{{$item->citizen->street}}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td colspan="2"
                                        style="color: #be2d45;">@if(!in_array($item->project->id,$project_arr)){{'غير مستفيد من مشاريع المركز'}}@else{{'مستفيد من مشاريع المركز '}}@endif</td>
                                    <td>اسم المشروع:</td>
                                    <td colspan="2"
                                        style="color: #be2d45;">{{$item->project->name ." ".$item->project->code }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive" style="border: solid 1px;">
                            <table class="table table-hover table-striped table-bordered"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="color: #be2d45;">{{$item->sent_typee->name}}</td>
                                </tr>
                                <tr>
                                    <td class="mo">تاريخ تقديم ال{{$form_type->find($type)->name}}:</td>
                                    <td style="color: #be2d45;">{{date('d-m-Y', strtotime( $item->created_at))}}</td>
                                ...
                                <tr>
                                    ...
                                    <td style="color: #be2d45;">{{$item->category->name}}</td>

                                    <td class="mo">موضوع ال{{$form_type->find($type)->name}}:</td>
                                    <td style="color: #be2d45;">{{$item->form_type->name}} {{$item->title }}</td>
                                </tr>
                                ...
                                @if($item->old_category_id)
                                    <tr>
                                        ...
                                        <td style="color: #be2d45;">{{$item->old_category->name}}</td>

                                        <td class="mo">اسم المستخدم الذي قام بإعادة تصنيف الفئة:</td>
                                        <td style="color: #be2d45;">{{$item->user_change_category->name}}</td>
                                    </tr>

                                @endif
                                <tr>
                                    <td class="mo" colspan="2">محتوى ال{{$form_type->find($type)->name}}:</td>
                                    <td colspan="2" style="color: #be2d45;">{{$item->content}}</td>
                                </tr>

                                @if($item->reformulate_content)
                                    <tr>
                                        <td class="mo">محتوى ال{{$form_type->find($type)->name}} المعدل بناءً على نتيجة
                                            الاستيضاح:
                                        </td>
                                        <td style="color: #be2d45;">{{$item->reformulate_content}}</td>

                                        <td class="mo">اسم المستخدم الذي قام بإعادة صياغة المحتوى:</td>
                                        <td style="color: #be2d45;">{{$item->user_change_content->full_name}}</td>
                                    </tr>
                                @endif
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary setup-content" id="step-1">
                                ...
                                <div class="panel-body">
                                    @if(in_array(2,$auth_circle_user) && ((!is_null($item->have_clarified) && $item->have_clarified == 1 && !is_null($item->need_clarification)) || !is_null($item->need_clarification) && $item->need_clarification == 0) && !is_null($item->deleting) && $item->deleting == 0 && !$item->form_response )
                                    ...
                                    @elseif((!is_null($item->need_clarification) && in_array(2,$auth_circle_user))  || (!is_null($item->need_clarification) && in_array(5,$auth_circle_user)))
                                        <div class="form-group row">
                                            <div class="col-sm-6 col-sm-offset-6">
                                                <label for="sent_type" class="col-form-label">هل
                                                    ال{{$form_type->find($type)->name}}
                                                            ...
                                                            <div class="col-sm-4">
                                                                @if(in_array(2,$auth_circle_user) && $item->reprocessing_form_id)
                                                                    <a style="margin-top: 25px;" target="_blank" class="btn btn-primary"
                                                                       href="/citizen/form/reprocessing_show/{{$item->citizen->id_number}}/{{$item->reprocessing_form_id}}">
                                            ...
                                            <form id="update_clarification_form_modal" class="prodcedure_2">
                                                ...
                                                <div id="explain_main_div" style="display: none;">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-8" id="reason_lack_clarification_div"
                                                             style="display: none">
                                                            <label class="col-sm-4 col-form-label">سبب عدم
                                                                الاستيضاح</label>
                                                            <input class="form-control" type="text"
                                                                   id="reason_lack_clarification"
                                                                   name="reason_lack_clarification" autocomplete="off">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group row">
                                                        <div id="reprocessing_div"
                                                            ...
                                                            <h4>يوصى بإعادة معالجة ال{{$form_type->find($type)->name}}
                                                                مع أخذ التوصيات التالية بعين الاعتبار: </h4>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                    ...
                                    @if(in_array(2,$auth_circle_user) &&  !is_null($item->deleting) && $item->deleting == 0 && !$item->form_response)
                                        <form id="delete_form_modal">
                                            ...
                                            <div class="form-group row deleted_div">
                                                ...
                                                <div class="col-sm-7">
                                                    <label for="sent_type" class="col-sm-4 col-form-label">اسم موظف الذي
                                                        قام
                                                        بالحذف</label>
                                        ...
                                        @if(!$item->form_response && !is_null($item->old_category_id))
                                            <form id="update_category_form_modal">
                                                ...
                                                <div class="form-group row" id="updated_category_div">
                                                    <div class="col-sm-12">
                                                        <label
                                                            class="col-sm-4 col-form-label">فئة {{$form_type->find($type)->name}}
                                                            (2)</label>
                                                        @if($item->type == 1)
                                    ...
                                    @else
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                <select id="response_type_select" name="response_type"
                                                        class="form-control"
                                                        style="width: 50% !important;" readonly="" disabled>
                                                    <option value="">اختر نوع</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <label for="sent_type" class="col-sm-4 col-form-label">صياغة
                                                    الرد</label>
                                                <textarea name="response" rows="2" cols="78"
                                        ...
                                        @if(in_array(3,$auth_circle_user) && $item->form_response)
                                            @if($item->form_response && is_null($item->form_response->objection_response))
                                                <fieldset class="scheduler-border">
                                                    <legend>اجراءات المصادقة</legend>
                                                    <form
        ...
        $(document).ready(function () {
            ...
            allNextBtn.click(function () {
                ...
                for (var i = 0; i < curInputs.length; i++) {
                    if ($(curInputs[i]).closest(".form-group.has-error")) {
                        isValid = false;
                    }
                }
        ...
        $('#update_clarification_form_modal').submit(function (e) {
            ...
            if ($(".prodcedure_2")[0]) {
                ...
                if (!$(".prodcedure_2 input[name='optradio1']:checked").val()) {
                    $(".prodcedure_2 #optradio1p").text('يرجى تحديد ما إذا كان <?php echo $form_type->find($type)->name;?> بحاجة للاستيضاح أم لا');
                    return;
                } else {
                    $("#optradio1p").hide();
                }
            ...
            $.post("/account/form/clarification_from_citizian/" + id, {
                ...
                var step = 1;
                if ($("input[name='optradio1']:checked").val() == 0 || $("input[name='optradio2']:checked").val() == 1 || $("input[name='optradio3']:checked").val() == 1) {
                    step = 2;
                }
