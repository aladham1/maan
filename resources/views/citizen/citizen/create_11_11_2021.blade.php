...
<section class="container-fluid login-wrap edit-wrap">
    <div class="row">
        ...
        @if($type == 1)
            <div class="col-md-12">
                <h5 class="inner-h5">الرجاء القيام بشرح الشكوى/ المشكلة التي تواجهها مع التأكيد على أنه سيتم التعامل مع المعلومات التي
                    ستقدمها بكل جدية وبسرية تامة</h5>
            </div>
        @else
            <div class="col-md-12">
                <h5 class="inner-h5"> نسعد باستقبال مقترحاتكم بما يساهم في تحسين الخدمات التي يقدمها المركز، يرجى التفضل بتوضيح
                    مقترحاتكم
                </h5>
            </div>
        @endif
