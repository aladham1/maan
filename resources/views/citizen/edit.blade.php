                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <form method="POST" class="form-horizontal" id="form1"
                                      action="/citizen/saveolde/{{$citizen['id']}}" autocomplete="off">
                                    @method('patch')
                                    @csrf
                                    ...
                                    <input type="hidden" name="private_email" value="{{$private_email}}">
                                    <input type="hidden" name="private_mobile" value="{{$private_mobile}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input
                                                ...
                                                type="text" value="{{$citizen["first_name"]}}" id="first_name"
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input
                                                ...
                                                type="text" value="{{$citizen["father_name"]}}" id="father_name"
                                                name="father_name">
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input
                                                ...
                                                type="text" value="{{$citizen["grandfather_name"]}}"
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input
                                                ...
                                                type="text" value="{{$citizen["last_name"]}}" id="last_name"
                                                name="last_name">
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input
                                                class="form-control {{($errors->first('id_number') ? " form-error" : "")}}"
                                                readonly type="number" value="{{$citizen["id_number"]}}" id="id_number"
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input
                                                class="form-control {{($errors->first('mobile') ? " form-error" : "")}}"
                                                type="tel" maxlength="10" onchange="phonenumber($(this).val(),1)"
                                                value="{{$citizen["mobile"]}}" id="mobile" name="mobile"
                                                autocomplete="mobile">
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input
                                                class="form-control {{($errors->first('mobile2') ? " form-error" : "")}}"
                                                type="tel"
                                                value="{{$citizen["mobile2"]}}" maxlength="10" id="mobile2"
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <select
                                                ...
                                                <option
                                                    value="شمال غزة" {{$citizen['governorate']=='شمال غزة'?"selected":""}}>
                                                    شمال غزة
                                                </option>
                                                <option value="غزة" {{$citizen['governorate']=='غزة'?"selected":""}}>
                                                    غزة
                                                </option>
                                                <option
                                                    value="الوسطى" {{$citizen['governorate']=='الوسطى'?"selected":""}}>
                                                    الوسطى
                                                </option>
                                                <option
                                                    value="خانيونس" {{$citizen['governorate']=='خانيونس'?"selected":""}}>
                                                    خانيونس
                                                </option>
                                                <option value="رفح" {{$citizen['governorate']=='رفح'?"selected":""}}>
                                                    رفح
                                                </option>
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input
                                                class="form-control {{($errors->first('city') ? " form-error" : "")}}"
                                                type="text" value="{{$citizen["city"]}}" id="city" name="city"
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input
                                                class="form-control {{($errors->first('street') ? " form-error" : "")}}"
                                                type="text" value="{{$citizen["street"]}}" id="street" name="street"
                                                autocomplete="street">
                                        ...
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input name="type_name"
                                                   value="@if(in_array($project_id,$project_arr)){{'مستفيد'}}@else{{'غير مستفيد'}}@endif"
                                                   type="text" readonly class="form-control">
                                        </div>

                                        <div class="col-md-3 mb-10">
                                            <label for="project_name" class="col-form-label">اسم المشروع</label>
                                            <input name="project_name" value="{{$project_name}}" type="text" readonly
                                                   class="form-control">
                                        </div>
                                    </div>
                                </form>
