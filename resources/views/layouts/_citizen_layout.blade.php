...
">
    ...
    list-style: none;"
                                            ...
                                            @foreach($items as $a)
                                                <li id="{{$a->id}}"
                                                    @if(empty($a->read_at) || is_null($a->read_at)) style="border-left: 4px solid #26c7c1;background-color: #c0ebe4;" @endif>
                                                    <a onclick="make_read(<?php echo $a->id;?>)" href="{{$a->link}}"
        ...
        <div class="row top-footer">
            ...
            <div class="col-sm-10 address">
                <ul class="footer-list">
                    ...
                    <li><i class="fa fa-map-marker footer-icon"></i><span><strong>العنوان:</strong>{{$itemco->address}}</span>
                    </li>
                    <li><i class="fa fa-phone footer-icon"></i><span><strong>الرقم المجاني:</strong>{{$itemco->free_number}}</span>
                    </li>
                    <li>
                        <i class="fa fa-phone footer-icon"></i><span><strong>رقم الهاتف الأرضي:</strong><span>{{$itemco->phone}}</span>
                    </li>
                    <li><i class="fa fa-mobile footer-icon"></i><span><strong>رقم الموبايل:</strong>{{$itemco->mopile}}</span>
                    </li>
                    <li><i class="fa fa-fax footer-icon"></i><span><strong>رقم الفاكس:</strong>{{$itemco->fax}}</span>
                    </li>
                </ul>
            </div>
