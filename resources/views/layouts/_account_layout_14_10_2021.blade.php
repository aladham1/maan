...
<head>
    ...
    <link href="{{asset('metronic-rtl/assets/global/plugins/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('metronic-rtl/assets/global/plugins/simple-line-icons/simple-line-icons.css')}}"
    ...
    <link href="{{asset('metronic-rtl/assets/layouts/layout/css/custom-rtl.min.css')}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('metronic-rtl/assets/layouts/layout/css/custom-manal.css')}}" rel="stylesheet"
          type="text/css"/>
                            ...
                            <ul class="dropdown-menu-list" id="notif" style="height: 300px;"
                                ...
                                @foreach($items as $a)
                                    <li id="{{$a->id}}"
                                        ...
                                        <a onclick="make_read(<?php echo $a->id;?>)" href="{{$a->link}}" class="d-flex justify-content-between">
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title"><span class='fa @yield("title_icon")'
                                                 aria-hidden='true'></span> @yield("title")
