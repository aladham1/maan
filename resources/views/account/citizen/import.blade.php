...
<table style="padding: 10px;border: 1px solid black;border-collapse: collapse;" border="1">
    ...
    @foreach($items as $item)
        <tr>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_first_name == 1) {{'background-color: #ff0000;'}} @endif">{{$item->first_name}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_father_name == 1) {{'background-color: #ff0000;'}} @endif">{{$item->father_name}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_grandfather_name == 1) {{'background-color: #ff0000;'}} @endif">{{$item->grandfather_name}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_last_name == 1) {{'background-color: #ff0000;'}} @endif">{{$item->last_name}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_id_number == 1) {{'background-color: #ff0000;'}} @endif">{{$item->id_number}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_mobile == 1) {{'background-color: #ff0000;'}} @endif">{{$item->mobile}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_mobile2 == 1) {{'background-color: #ff0000;'}} @endif">{{$item->mobile2 ? $item->mobile2 : '-'}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_governorate == 1) {{'background-color: #ff0000;'}} @endif">{{$item->governorate}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_city == 1) {{'background-color: #ff0000;'}} @endif">{{$item->city}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_street == 1) {{'background-color: #ff0000;'}} @endif">{{$item->street}}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;@if($item->error_project_request == 1) {{'background-color: #ff0000;'}} @endif">{{$item->project_request ? $item->project_request : '-'}}</td>
        </tr>
    @endforeach
    </tbody>
</table>
