        ...
        <div class="form-group row">
            <div class="col-sm-3">
                ...
                <select class="form-control {{($errors->first('governorate') ? " form-error" : "")}}" name="governorate">
                    ...
                    <option value="أريحا" {{$item['governorate']=='أريحا'?"selected":""}}>
                        أريحا
                    </option>

                    <option value="الخليل" {{$item['governorate']=='الخليل'?"selected":""}}>
                        الخليل
                    </option>

                    <option value="القدس" {{$item['governorate']=='القدس'?"selected":""}}>
                        القدس
                    </option>

                    <option value="بيت لحم" {{$item['governorate']=='بيت لحم'?"selected":""}}>
                        بيت لحم
                    </option>
                    <option value="جنين" {{$item['governorate']=='جنين'?"selected":""}}>
                        جنين
                    </option>
                    <option value="رام الله والبيرة" {{$item['governorate']=='رام الله والبيرة'?"selected":""}}>
                        رام الله والبيرة
                    </option>
                    <option value="سلفيت" {{$item['governorate']=='سلفيت'?"selected":""}}>
                        سلفيت
                    </option>
                    <option value="طوباس" {{$item['governorate']=='طوباس'?"selected":""}}>
                        طوباس
                    </option>
                    <option value="طولكرم" {{$item['governorate']=='طولكرم'?"selected":""}}>
                        طولكرم
                    </option>
                    <option value="قلقيلية" {{$item['governorate']=='قلقيلية'?"selected":""}}>
                        قلقيلية
                    </option>
                    <option value="نابلس" {{$item['governorate']=='نابلس'?"selected":""}}>
                        نابلس
                    </option>
                                ...
                                @if($project->id !=1)
                                    <tr>
                                        ...
                                        @if($item->projects->contains($project->id))
                                            ...
                                            $xx = $item->citizen_projects->where('project_id',$project->id)->first();
                                            ?>
                                            <td><input type="text" class="form-control" value="{{$xx->project_request}}"  id="project_request" name="project_request[{{$key}}]"></td>
                                        @else
                                            <td><input type="text" class="form-control"   id="project_request" name="project_request[{{$key}}]"></td>
                                        @endif
                                    </tr>
                                @endif
                            @endforeach
