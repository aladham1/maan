                        ...
                        <form method="post" enctype="multipart/form-data" action="/account/account" autocomplete="off">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control {{($errors->first('user_name') ? " form-error" : "")}}"
                                           type="text" value="{{old("user_name")}}" id="user_name" name="user_name"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control {{($errors->first('id_number') ? " form-error" : "")}}"
                                           type="text" value="{{old("id_number")}}" id="id_number" name="id_number">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control {{($errors->first('mobile') ? " form-error" : "")}}"
                                           type="text" placeholder="" value="{{old("mobile")}}" id="mobile"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control {{($errors->first('email') ? " form-error" : "")}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control {{($errors->first('password') ? " form-error" : "")}}"
                                           type="password" value="{{old("password")}}" id="password" name="password"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control {{($errors->first('circle_id') ? " form-error" : "")}}"
                                            name="circle_id">
                                        <option value="">اختر</option>
                                        @foreach($circles as $circle)
                                            <option
                                                value="{{$circle -> id}}" {{old('circle_id')==$circle -> id?"selected":""}}>{{$circle -> name}}</option>
                                        @endforeach
                                    </select>
...
{{--                                <div class="col-sm-4">--}}
{{--                                    <select--}}
{{--                                        class="form-control {{($errors->first('private') ? " form-error" : "")}}"--}}
{{--                                        name="private">--}}
{{--                                        <option value="">اختر</option>--}}
{{--                                        <option value="1" {{old('private') == 1 ?"selected":""}}>نعم</option>--}}
{{--                                        <option value="0" {{old('private') == 0 ?"selected":""}}>لا</option>--}}
{{--                                    </select>--}}
{{--                                </div>--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    {!! $errors->first('private', '<p class="help-block" style="color:red;">:message</p>') !!}--}}
{{--                                </div>--}}
{{--                            </div>--}}
