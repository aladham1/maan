...
{{--                                                        <td style="max-width: 100px;text-overflow: ellipsis;white-space: nowrap;">@if($a->private == 1) {{'نعم'}} @else {{'لا'}} @endif</td>--}}
...
{{--                                                                   href="/account/account/forminaccount/{{$a->id}}">الاقتراحات/الشكاوى</a>--}}
{{--                                                            @endif--}}
                                                            ...
                                                            @if(check_permission('تعديل بيانات المستخدم'))
                                                                <a class="btn btn-sm btn-primary" title="تعديل"
                                                                   href="/account/account/{{$a->id}}/edit"><i
                                                                        class="fa fa-edit"></i>
                                                                </a>
                                                            @endif
