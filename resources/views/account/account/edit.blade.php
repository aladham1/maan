...
@section("title", "تعديل بيانات حساب المستخدم $item->full_name")
...
{{--                    name="private">--}}
{{--                    <option value="">اختر</option>--}}
{{--                    <option value="1" {{$item['private'] == 1 ?"selected":""}}>نعم</option>--}}
{{--                    <option value="0" {{$item['private'] == 0 ?"selected":""}}>لا</option>--}}
{{--                </select>--}}
{{--            </div>--}}
{{--            <div class="col-sm-12">--}}
