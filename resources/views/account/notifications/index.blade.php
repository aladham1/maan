        ...
        <div class="table-responsive">
            <table class="table">
                ...
                @foreach($items as $a)
                    ...
                    ?>
                    <tr style="@if(empty($a->read_at) || is_null($a->read_at)) background-color: #f1cfc0;@endif">
                        <td style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{{$a->id}}</td>
                        <td style="max-width: 200px;overflow: hidden;text-overflow: ellipsis;white-space: normal;">{{$a->title}}</td>
                        <td style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{{ ($a->receiver_id != 0) ? $circle->name  : 'مدير النظام' }}</td>
                        <td style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{{ ($a->receiver_id != 0) ? $Account->full_name  : 'مدير النظام' }}</td>
