...
عزيزي موظف المركز من خلال هذه الواجهة يمكنك استدعاء أي نوع من أنواع التقارير حول الاقتراحات والشكاوى المقدمة للمركز
</h4>
                            </div>
                        </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="card-header">
                    <div class="card-title">محتويات/ بيانات التقرير</div>
                </div>
                <div class="card-body">
                    <h4>
...
خيارات استدعاء محتويات/ بيانات التقرير
 </h4>
  <hr>
     <div class="row">
        <div class="col-sm-12">
        ...
        <fieldset>
            <div id="report_critiria">
                <div class="form-group row">
                    <div class="col-sm-3 adv-search" style="margin-top:0px;margin-bottom:0px;">
                ...
                <div class="form-group row">
                    <div class="col-sm-3 adv-search" style="margin-top:0px;margin-bottom:0px;margin-top: 24px;">
                ...
                <div class="form-group row" align="left">
                    <div class="col-sm-12 adv-search">
                        ...
                        <button type="submit" name="theaction" value="search" style="width: 110px;display: inline-block;" class="btn btn-primary adv-searchh"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>     بحث    </button>
                    </div>
                </div>
                <hr>
            </div>
    ...
    <button class="btn btn-success" style="float: left;margin-top: 30px;margin-bottom: 15px;" onclick="@if($determine == "specific_project")printDiv('specific_project')@elseif($determine == "all_projects")printDiv('all_projects')@endif"><span class="glyphicon glyphicon-print"></span> طباعة</button>
</div></div></div></div></div>
