            ...
            <!--**************************************************  الصفحة الرئيسية *****************************************************************-->
                ...
                <div id="services" class="container text-center">
                        ...
                        <div class="col-md-4 wow bounceInLeft">
                            <div class="card">
								...
								<div class="box">
                                    ...
                                    <p>{{$itemco->add_propusel_clouse}}</p>
                                </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row" style="display: inline-flex;margin-top: 20px;" >
                        <div class="col-md-12">
                            <a  target="_blank" class="btn btn-danger btn-puplic" href="{{url('uploads/'.$itemco->steps_file)}}">ارشادات عامة</a>
                        </div>
                     </div>
              </section>
                </div>
    ...
    <div class="row top-footer">
        ...
        <div class="col-sm-10 address">
            <ul class="footer-list">
                ...
                <li><i class="fa fa-map-marker footer-icon"></i><span><strong>العنوان:</strong>{{$itemco->address}}</span></li>
                <li><i class="fa fa-phone footer-icon"></i><span><strong>الرقم المجاني:</strong>{{$itemco->free_number}}</span></li>
                <li><i class="fa fa-phone footer-icon"></i><span><strong>رقم الهاتف الأرضي:</strong><span>{{$itemco->phone}}</span></li>
                <li><i class="fa fa-mobile footer-icon"></i><span><strong>رقم الموبايل:</strong>{{$itemco->mopile}}</span></li>
                <li><i class="fa fa-fax footer-icon"></i><span><strong>رقم الفاكس:</strong>{{$itemco->fax}}</span></li>
            </ul>
        </div>
