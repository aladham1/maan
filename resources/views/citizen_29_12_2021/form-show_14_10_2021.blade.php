...
@section('css')
    <style>
        ...
        .panel#first_panel.open, .panel#second_panel.open {
            min-height: 260px !important;
            overflow: auto !important;

        }

        /*#first_panel.open,#second_panel.open  {*/
        /*    min-height: 260px !important;*/
        /*}*/
...
">                                معالجة ال{{$item->form_type->name}}
                    ...
                    <div class="panel" id="first_panel">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" style="width:100%;white-space:normal;font-weight: 600">
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td colspan="2" style="color: #be2d45;">@if(!in_array($item->project->id,$project_arr)){{'غير مستفيد من مشاريع المركز'}}@else{{'مستفيد من مشاريع المركز '}}@endif</td>
                                    <td>اسم المشروع:</td>
                                    <td colspan="2" style="color: #be2d45;">{{$item->project->name ." ".$item->project->code }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                                    ...
                                    @elseif((!is_null($item->need_clarification) && in_array(2,$auth_circle_user))  || (!is_null($item->need_clarification) && in_array(5,$auth_circle_user)))
                                        ...
                                        <div id="explain_main_div" style="display: none;">
                                            ...
                                            @elseif($item->reason_lack_clarification)
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <label class="xx">اسم المستخدم الذي قام بوضع سبب عدم الاستيضاح:</label>
                                                        <input class="form-control"
                                                               value="{{$item->user_change_content->full_name}}"
                                                               readonly/>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6 col-sm-offset-6">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-group form-check-input" name="optradio1"
                                                                           value="0">
                                                                    لا
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-check-inline">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input"
                                                                       ...
                                                                       name="optradio"
                                                                       value="1" @if($item->deleting == 1){{'checked'}}@endif> نعم
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    @else
                                        ...
                                        <div id="replay_advanced" style="@if(!$item->required_respond)display: none @endif">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    <label for="response_type" class="col-sm-4 col-form-label">ملف توثيق الإجراء</label>

                                                    <a style="width: 50%;" target="_blank" class="btn btn-primary" title="ملف توثيق الإجراء"
   ...
   <textarea id="content" class="form-control {{($errors->first('recommendations_content') ? " form-error" : "")}}"
             rows="6" id="recommendations_content" name="recommendations_content">{{old("recommendations_content")}}
   </textarea>
...
@section("content")
    <div class="row" style="text-align:center;">
        ...
        <h2 class="col-sm-6" style="margin-top:120px;margin-bottom:30px;color:#af0922;margin-left:337px;">لا يوجد صلاحية للمعالجة</h2>
