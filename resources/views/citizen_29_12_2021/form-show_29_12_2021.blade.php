                    ...
                    <div class="panel" id="first_panel">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered"
                                ...
                                <tr class="showdateciz">
                                    <td>المنطقة :</td>
                                    <td style="color: #be2d45;">{{$item->citizen->city}}</td>
                                    <td>العنوان:</td>
                                    <td style="color: #be2d45;">{{$item->citizen->street}}</td>
                                    ...
                                    ?>
                                    <td
                                        style="color: #be2d45;">@if(!in_array($item->project->id,$project_arr)){{'غير مستفيد من مشاريع المركز'}}@else{{'مستفيد من مشاريع المركز '}}@endif
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    @if($item->project_id != 1)
                                        ...
                                        <td style="color: #be2d45;">{{$item->citizen->citizen_projects()->where('project_id',$item->project_id)->first()->project_request}}</td>
                                    @else
                                        <td style="color: #be2d45;"></td>
                                    @endif

                                    <td>رمز المشروع:</td>
                                    <td style="color: #be2d45;">{{$item->project->code}}
                                    </td>
                                    <td>اسم المشروع:</td>
                                    <td colspan="2"
                                        style="color: #be2d45;">{{$item->project->name}}
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered"
                                ...
                                <tr>
                                    ...
                                    <td style="color: #be2d45;">{{$item->sent_typee->name}}</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" style="color: #be2d45;">{{$item->content}}</td>
                                </tr>
                                ...
                                @if($item->reformulate_content)
                                    <tr>
                                        ...
                                        <td style="color: #be2d45;" colspan="3">{{$item->reformulate_content}}</td>
                                        ...
                                        @if($item->recommendations_for_deleting)
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td>التوصيات:</td>
                                                    <td>
                                                        <p>يوصى بإتمام الشكوى </p>
                                                        {{$item->recommendations_for_deleting}}</td>
                                                </tr>
                                            </table>
                                            <div>
                                                <a style="margin-top: 25px;float: left;" target="_blank" class="btn btn-primary"
                                                   href="/citizen/form/show/{{$item->citizen->id_number}}/{{$item->reprocessing_form_id}}">
                                                    <span class="fa fa-refresh"></span>
                                                    إعادة معالجة ال{{$form_type->find($type)->name}}
                                            ...
                                            <form id="update_category_form_modal">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6 col-sm-offset-6">
                                                        <label for="sent_type" class="col-form-label">هل
                                                            ال{{$form_type->find($type)->name}}
                                                            بحاجة لإعادة تصنيف فئتها؟</label>
                                                        <div class="col-sm-2">
                                                            <div class="form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input"
                                                ...
                                                <div class="form-group row" id="updated_category_div">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <label class="col-sm-4 col-form-label">
                                                            فئة ال{{$form_type->find($type)->name}} المعدلة بناءً على محتوى الشكوى:
                                                        </label>
                                                        @if($item->type == 1)
                                        ...
                                        <form action="{{route('change_response_and_update_form_data' , $item->id)}}"
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="response" rows="2" cols="115"
                                                              style="border-radius: 10px;"></textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <label for="sent_type" class="col-sm-4 col-form-label">الجهة المختصة بالمصادقة على الرد:</label>
                                                    <input style="width: 65% !important;" type="text"
                                                           class="form-control"
                                                           name="confirm_replay_user_name" readonly
                                                           value="@if($item->form_response){{ $item->form_response->confirm_account->full_name }}@endif">
                                                </div>
                                        ...
                                        @if($item->form_response && !is_null($item->form_response->objection_response))
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12" id="objection_response_div"
                                                    ...
                                                    <textarea name="old_response" rows="2" cols="115"
...
@section("content")
    <div class="row" style="text-align:center;">
        <div class="col-md-12">
            <div class="alert alert-danger alert-dismissible">لا يوجد لديك صلاحية للمعالجة</div>
        </div>
    </div>
@endsection
@endif
    ...
    <script>
        $('#delete_form_modal').submit(function (e) {
            ...
            if (!$("input[name='optradio']:checked").val()) {
                ...
                $("#optradiop").text('يرجى تحديد مدى احتياج ال<?php echo $form_type->find($type)->name; ?> للحذف');
                return;
            } else {
                $("#optradiop").hide();
            }
        ...
        $('#confirm_delete_form_modal').submit(function (e) {
            ...
            if (!$("input[name='optradio6']:checked").val()) {
                ...
                $("#optradio7p").text('يرجى تحديد مدى احتياج ال<?php echo $form_type->find($type)->name; ?> للحذف');
                return;
            } else {
                $("#optradio7p").hide();
            }
            ...
            if (inputValue == 1) {
                ...
                if (!deleting_reprocessing_recommendations) {
                    $("#optradio8p").text('يرجى تحديد التوصيات المطلوبة لإعادة معالجة ال<?php echo $form_type->find($type)->name; ?>');
                    return;
                } else {
                    $("#optradio8p").hide();
                }
