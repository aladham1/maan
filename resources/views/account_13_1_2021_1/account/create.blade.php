...
@section("content")
    <form method="post" autocomplete="off" enctype="multipart/form-data" action="/account/account">
        {{csrf_field()}}
        <div class="row">
	        <div class="col-sm-4">
        ...
        <div class="form-group row">
            <div class="col-sm-6">
                ...
                <input autocomplete="off" class="form-control {{($errors->first('user_name') ? " form-error" : "")}}" type="text" value="{{old("user_name")}}" id="user_name" name="user_name">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                ...
                <input autocomplete="off" class="form-control {{($errors->first('password') ? " form-error" : "")}}" type="password" value="{{old("password")}}" id="password" name="password">
