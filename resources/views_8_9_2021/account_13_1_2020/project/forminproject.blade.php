    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <th style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;">فئة مقدم الاقتراح / الشكوى</th>
                ...
                <th style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;">فئة الاقتراح/ الشكوى</th>
                <th style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;">تاريخ تسجيل الاقتراح/الشكوى</th>
