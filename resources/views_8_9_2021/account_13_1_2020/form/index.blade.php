...
@section("content")
    <div class="row">
        ...
        <div class="col-sm-4 col-md-6" style="text-align: center;">
            <a target="_blank" class="btn btn-success" href="/#تقديم%20الطلب"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> إضافة اقتراح/شكوى</a>
...
{{--                               placeholder="ابحث في الرقم المرجعي، الاسم أو رقم الهوية"/>--}}
{{--                    </div>--}}
                    <div class="col-sm-4">
