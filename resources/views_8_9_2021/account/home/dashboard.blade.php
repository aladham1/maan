        ...
        <?php
                    ...
                    <div class="row">
					  ...
					  <tr>
					    ...
					    <td style="width: 100px;">{{ Auth::user()->account->circle->name }}</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
					    ...
					    <td style="width: 100px;">{{ Auth::user()->account->mobile }}</td>
                                        ...
                                        <table class="table table-striped table-advance table-hover">
                                            ...
                                            @foreach($items as $a)
                                                <tr>
                                                    ...
                                                    <td class="hidden-xs"> @if($a->account_projects && $a->account_projects->where('rate','=','3')->first())
