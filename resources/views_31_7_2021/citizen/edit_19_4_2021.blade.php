...
{{--                                                @endif--}}
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label for="datee"  class="col-sm-4 col-form-label">تاريخ تقديم ال{{$form_type->find($type)->name}} </label>
                                        <input type="text" class="col-sm-4  form-control datepicker" name="datee"  value="{{old('datee')}}" />
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label for="title"  class="col-sm-4 col-form-label">موضوع ال{{$form_type->find($type)->name}}</label>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label for="content"  class="col-sm-4 col-form-label">محتوى ال{{$form_type->find($type)->name}}</label>
