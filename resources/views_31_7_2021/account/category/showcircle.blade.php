...
@section("content")
    <div class="row">
        <div class="col-md-12">
            <h4>هذه الواجهة مخصصة لعرض المستويات الإدارية التابعة لفئة الاقتراح/ الشكوى</h4>
        </div>
    </div>
    <div class="row" id="app">
        <div class="col-md-12">
            ...
            <div class="table-responsive" id="editLevelTable2">
                ...
                <table style="width:30% !important;max-width:80% !important;white-space:normal;"
                       class="table table-hover table-striped">

                    <tr>
                        <th style="max-width: 100px;word-break: normal; background:#ed6b75;color:#fff;">الفئة الرئيسية
                        </th>
                    ...
                    <tbody>
                    <tr>
                        <th style="max-width: 100px;word-break: normal; background:#ed6b75;color:#fff;">الفئة الفرعية
                        </th>
