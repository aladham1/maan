            ...
            <div class="card-body">
              <form autocomplete="off">
                <div class="row">
                  ...
                  <button type="submit" target="_blank" name="theaction" title="تصدير إكسل" value="excel" class="btn btn-primary adv-search-btnn" id="excel_b" style="margin-left: 10px;">
...
{{--                        @endif--}}
                        ...
                        @if(check_permission('تعديل بيانات المستفيد'))
                            <a class="btn btn-xs btn-primary blue-btn" title="تعديل" href="/account/citizen/{{$a->id}}/edit"><i
                                        class="fa fa-edit"></i></a>
                        @endif

                        @if(check_permission('حذف المستفيد'))
                            <a class="btn btn-xs Confirm btn-danger red-btn" title="حذف" href="/account/citizen/delete/{{$a->project_request_id}}"><i
