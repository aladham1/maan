    ...
    @foreach($items as $item)
        <tr>
            <?php $Citizen = \App\Citizen::find($item->citizen_id); ?>
                ...
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $Citizen->first_name .' '.$Citizen->father_name .' '.$Citizen->grandfather_name.' '.$Citizen->last_name }}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $Citizen->id_number }}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $Citizen->governorate }}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $Citizen->city }}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $Citizen->street }}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $Citizen->mobile }}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $Citizen->mobile2 ? $Citizen->mobile2  : '' }}</td>
                ...
                ?>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $xx->project_request }}</td>
                <?php }else{?>
                ...
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;">{{$item->box_place}}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;">{{$item->date_open_box}}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;">{{$item->number_of_open_box}}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;">{{$item->type_of_followup_visit}}</td>
                ...
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">@if($item->have_clarified == 1){{'نعم'}}@else{{'لا'}}@endif</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->reason_lack_clarification}}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->reformulate_content}}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->nammes}}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->user_change_content_full_name}}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->response_type}}</td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->required_respond}}</td>
                ...
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->form_status_ttt}}</td>
                ...
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->evaluate}}</td>
                ...
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">@if($item->reprocessing_form_id){{'نعم'}}@else{{'لا'}}@endif</td>
        </tr>
    @endforeach
    </tbody>
</table>
