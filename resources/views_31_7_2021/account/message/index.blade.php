...
@section('content')
    <span id="mybody">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <thead>
                <tr>
                    <th style="max-width: 25%; word-break: normal;">
                         <a target="_blank" href="https://www.hotsms.ps/portal/user/dashboard" class="">
    ...
    <div class="mt-3"></div>
        <div class="row">
            <div class="col-md-12">
                <h4>يمكنك من خلال الجدول أدناه عرض الرسائل المدرجة في النظام.</h4>
            </div>
        </div>
        @if($items)
            @if($items->count()>0)
