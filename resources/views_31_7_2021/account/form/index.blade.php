            ...
            <div class="card-body">
               <form autocomplete="off">
                ...
                <div class="row">
                  ...
                  <button type="submit" target="_blank" name="theaction" title="تصدير إكسل" id="excel_b" value="excel" class="btn btn-primary adv-search-btnn" style="margin-left: 10px;">
        ...
        <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 adv-search">
                        ...
                        <button type="submit" name="theaction" title="بحث" style="display: block;margin-top:0px"
                                value="search"
