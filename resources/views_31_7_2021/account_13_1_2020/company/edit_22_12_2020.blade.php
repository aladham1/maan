...
<i class="fa fa-download" aria-hidden="true"></i> تحميل نسخة اختياطية من قاعدة البيانات
</div>
</div>
        ...
        <div class="col-md-6">
            <form action="/account/company/{{$item['id']}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="رقم الهاتف" name="mopile" value="{{$item['mopile']}}">
                </div>
                <div class="form-group">
                    <label>رقم المحمول</label>
                    <input type="text" class="form-control" placeholder="رقم المحمول" name="phone" value="{{$item['phone']}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group row">
                    <div class="col-md-8">
                        <label>ملف الارشادات العامة الحالي </label>
                    </div>
                    <div class="col-md-6">
                        <input type="file"  name="file_home">
                    </div>
                    <div class="col-md-6">
                        <a target="_blank" href="{{url('uploads/'.$item->steps_file)}}">تنزيل الملف الحالي</a>
                    </div>
                </div>
                <br>
