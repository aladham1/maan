...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-9 col-md-8">
            <h4>هذه الواجهة مخصصة للتحكم في إدارة المستويات الإداري</h4>
	</div>
                ...
                <tbody>
                    @foreach($items as $a)
                        ...
                        <td style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">
                            ...
                            <a class="btn btn-xs btn-info" href="/account/circle/select-category/{{$a->id}}"> فئات الشكاوي والاقتراحات</a>
