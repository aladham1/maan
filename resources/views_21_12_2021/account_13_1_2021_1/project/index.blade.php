        ...
        <form>
            ...
            <div style="margin-bottom: 20px;margin-top: 25px;" class="row">
               ...
               <div class="col-sm-4 adv-searchh">
                   <input type="text" class="form-control" name="code" placeholder="رمز المشروع" >
               </div>

               <div class="col-sm-4 adv-searchh">
                   <input  type="text" class="form-control" name="coordinator" placeholder="منسق المشروع" >
               </div>
            ...
            <div style="margin-bottom: 20px" class="row">
                ...
                <div class="col-sm-4 adv-searchh">
                    <input  type="text" class="form-control" name="manager" placeholder="مدير البرنامج" >
                </div>

                <div class="col-sm-4 adv-searchh">
                    <input  type="text"  class="form-control" name="support" placeholder="ممثل المتابعة و التقييم" >
                </div>
