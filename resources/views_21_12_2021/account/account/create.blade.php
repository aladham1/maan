    ...
    <form method="post" enctype="multipart/form-data" action="/account/account" autocomplete="off">
        ...
        <div class="form-group row">
            <div class="col-sm-4">
                ...
                <input class="form-control {{($errors->first('user_name') ? " form-error" : "")}}" type="text" value="{{old("user_name")}}" id="user_name" name="user_name" autocomplete="user_name">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                ...
                <input  class="form-control {{($errors->first('password') ? " form-error" : "")}}" type="password" value="{{old("password")}}" id="password" name="password" autocomplete="mobile">
