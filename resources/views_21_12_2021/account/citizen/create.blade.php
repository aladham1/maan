...
@section("content")
    ...
    font-size: 16px;">يمكنك من هذا التبويب إضافة المستفيدين من خلال قائمة</label>
                                <form action="{{ route('save-citizen-data') }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            ...
                                            <a href="{{ route('download-citizen-file') }}"
                                        ...
                                        <div class="col-sm-6" style="display: inline-flex;margin-top: 2%;">
                                            <input
                                                class="form-control {{($errors->first('data_file') ? " form-error" : "")}}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <select
                                                class="form-control {{($errors->first('project_id') ? " form-error" : "")}}"
                                                name="project_id">
    ...
    font-size: 16px;">يمكنك من هذا التبويب إضافة مستفيد جديد بشكل منفصل</label>
                                ...
                                <form id="addNewForm" method="post" action="/account/citizen"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text" autofocus
                                                   ...
                                                   value="{{old("id_number")}}" id="id_number_1"
                                                   name="id_number">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input
                                                ...
                                                value="{{old("mobile")}}" id="mobile" name="mobile" autocomplete="nope">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input
                                                ...
                                                type="tel"
                                                value="{{old("mobile2")}}" maxlength="10" id="mobile2" name="mobile2"
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <select
                                                ...
                                                <option value="غزة" {{old('governorate')=='غزة'?"selected":""}}>غزة
                                                </option>
                                                <option value="الوسطى" {{old('governorate')=='الوسطى'?"selected":""}}>
                                                    الوسطى
                                                </option>
                                                <option value="خانيونس" {{old('governorate')=='خانيونس'?"selected":""}}>
                                                    خانيونس
                                                </option>
                                                <option value="رفح" {{old('governorate')=='رفح'?"selected":""}}>رفح
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{old("city")}}" id="city" name="city" autocomplete="nope">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <label for="project_id" class="col-form-label"
                                                   style="font-weight:600;margin-top:20px;margin-bottom:20px;">لإضافة
                                                المستفيد ضمن مشروع آخر، حدد اسم المشروع المراد إدراج المستفيد
                                                ضمنه:</label>
                                                ...
                                                <table class="table table-hover table-striped" style="text-align: right;">
                                                    ...
                                                    @foreach($projects as $key => $project)
                                                        @if($project->id !=1)
                                                            <tr>
                                                                <td>{{$key+1}}</td>
                                                                <td><input type="checkbox" name="projects[]"
                                                                           value="{{$project->id.'_'.$key}}"/></td>
                                                                <td><b>{{$project->name}}</b></td>
                                                                <td><input type="text" class="form-control"
                                                                           id="project_request"
                                                                           name="project_request[]"></td>
                                                            </tr>
                                                        @endif
                                                    @endforeach
                                                </table>
                                    ...
                                    <div class="form-group row" style="float:left;text-align:left;" align="left">
                                        <div class="col-md-12">
                                            <input type="submit" class="btn btn-success xxxx" value="حفظ"/>
