...
<table style="padding: 10px;border: 1px solid black;border-collapse: collapse;" border="1">
    <thead>
    <tr>
        <td colspan="41" style="font-weight:bold;text-align: center;vertical-align:center;background-color: #d8d8ec;height: 20px;padding: 10px;border: 1px solid black;border-collapse: collapse;">
            نظام مركز معاً لإدارة الاقتراحات والشكاوى- ملحق رقم (12): بيانات متابعة مدى دقة بيانات الاقتراحات والشكاوى المسجلة على النظام.
        </td>
    </tr>
    <tr>
        <td colspan="18" style="font-weight:bold;text-align: center;vertical-align:center;background-color: #9bc2e6;height: 20px;padding: 10px;border: 1px solid black;border-collapse: collapse;">المعلومات الأساسية:</td>
        <td colspan="23" style="font-weight:bold;text-align: center;vertical-align:center;background-color: #f4b084;height: 20px;padding: 10px;border: 1px solid black;border-collapse: collapse;">معلومات المتابعة:</td>
    </tr>
    <tr>
        <th style="background-color:#bdd7ee;word-break: normal;">الرقم المرجعي</th>
        <th style="background-color:#bdd7ee;max-width: 100px;word-break: normal;">الاسم رباعي</th>
        ...
        <th style="background-color:#bdd7ee;max-width: 100px;word-break: normal;">فئة مقدم الاقتراح/الشكوى</th>
        ...
        <th style="background-color:#f8cbad;max-width: 100px;word-break: normal;">حالة التقدم باقتراح/شكوى:</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">مدى مطابقته للبيانات المسجلة على النظام</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">في حال الإجابة بـ (غير مطابق)، الرجاء التوضيح:</th>

        <th style="background-color:#f8cbad;max-width: 100px;word-break: normal;">قناة استقبال الاقتراح/الشكوى:</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">مدى مطابقته للبيانات المسجلة على النظام</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">في حال الإجابة بـ (غير مطابق)، ما هي القناة التي قمت من خلالها تقديم الاقتراح/الشكوى؟</th>

        <th style="background-color:#f8cbad;max-width: 100px;word-break: normal;">ضوع الاقتراح/الشكوى:</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">مدى مطابقته للبيانات المسجلة على النظام</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">في حال عدم الإجابة بـ (مطابق بشكل كلي)، ما هو موضوع اقتراحك/شكوتك؟</th>

        <th style="background-color:#f8cbad;max-width: 100px;word-break: normal;">حالة تبليغ الرد:</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">مدى مطابقته للبيانات المسجلة على النظام</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">في حال الإجابة بـ (غير مطابق)، الرجاء التوضيح:</th>

        <th style="background-color:#f8cbad;max-width: 100px;word-break: normal;">تاريخ تبليغ الرد:</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">مدى مطابقته للبيانات المسجلة على النظام</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">في حال الإجابة بـ (غير مطابق)، ما هو التاريخ الذي تلقيت فيه الرد؟</th>

        <th style="background-color:#f8cbad;max-width: 100px;word-break: normal;">الرد النهائي على الاقتراح/الشكوى:</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">مدى مطابقته للبيانات المسجلة على النظام</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">في حال عدم الإجابة بـ (مطابق بشكل كلي)، ما هو الرد الذي تلقيته على اقتراحك/شكوتك؟</th>

        <th style="background-color:#f8cbad;max-width: 100px;word-break: normal;">التغذية الراجعة:</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">مدى مطابقته للبيانات المسجلة على النظام</th>
        <th style="background-color:#fce4d6;max-width: 100px;word-break: normal;">في حال الإجابة بـ (غير مطابق)، ما هو مستوى رضاك عن الرد الذي تلقيته: </th>
    ...
    @foreach($items as $item)
        <tr class="tr-id-{{$item->accuracy_form_id}}">
            <td style="word-break: normal;">{{$item->accuracy_form_id}}</td>
            ...
            <td style="max-width: 100px;word-break: normal;">{{$item->accuracy_form_id == 1 ? 'غير مستفيد' : ' مستفيد' }}</td>
            ...
            @if($item->followup_accuracy_id)
                <td style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{{$item->form_type_name}}</td>
                ...
                <td style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{{$item->question7}}</td>
                <td style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{{$item->question8}}</td>
                <td style="max-width: 100px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{{$item->question9}}</td>
            @else
