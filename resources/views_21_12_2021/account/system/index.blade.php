...
@section("title", "متابعة نشر إجراءات النظام")
@section("content")
    <div class="row">
                                ...
                                @if($items->count()>0)
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped"
                                            ...
                                            @foreach($items as $a)
                                                <tr class="tr-id-{{$a->id}}">
                                                    <td style="word-break: normal;">{{$a->project_request}}</td>
                                                    ...
                                                    <td style="max-width: 150px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">
                                                        @if(!$a->followup_post_system_id)
                                                            <a
                                                                target="_blank" title="معاينة" class="btn btn-xs btn-primary"
                                                                href="/account/system/create/{{$a->citizen_project_id}}">
                                                                <i class="glyphicon glyphicon-eye-open"></i>
                                                            </a>
                                                        @else
                                                            <a
                                                                target="_blank" title="معاينة" class="btn btn-xs btn-primary"
                                                                href="/account/system/edit/{{$a->followup_post_system_id}}">
                                                                <i class="glyphicon glyphicon-eye-open"></i>
                                                            </a>
                                                        @endif
                                                        ...
                                                        <a class="btn btn-xs Confirm22 btn-danger" data-id="{{$a->followup_post_system_id}}"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
    ...
    <script>
        $(function () {
            ...
            $('#delete_form_modal').submit(function (e) {
                ...
                $.post("{{route('delete_followup_post_system')}}", {
                    "_token": "{{csrf_token()}}",
                    'id': id,
                }, function (data) {
