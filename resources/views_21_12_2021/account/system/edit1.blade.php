...
@section("title", "تعديل متابعة دقة البيانات المسجلة على النظام")
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-bordered"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                class="form-control {{($errors->first('question1') ? " form-error" : "")}}"
                                                name="question1" id="question1">
                                                <option value="">اختر</option>
                                                <option {{ $item->question1 == 1 ? "selected" : "" }} value="1">مطابق
                                                </option>
                                                <option {{ $item->question1 == 2 ? "selected" : "" }} value="2">غير
                                                    مطابق
                                                </option>
                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input style="width: 75%;" type="text"
                                                               class="col-sm-9 form-control {{($errors->first('question1_note') ? " form-error" : "")}}"
                                                               value="{{ $item->question1_note}}" name="question1_note"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                class="form-control {{($errors->first('question2') ? " form-error" : "")}}"
                                                name="question2" id="question2">
                                                <option value="">اختر</option>
                                                <option {{ $item->question2 == 1 ? "selected" : "" }} value="1">مطابق
                                                </option>
                                                <option {{ $item->question2 == 2 ? "selected" : "" }} value="2">غير
                                                    مطابق
                                                </option>
                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <select style="width: 50%"
                                                                class="form-control  {{($errors->first('question2_note') ? " form-error" : "")}}"
                                                                name="question2_note">
                                                            <option value="">اختر</option>
                                                            @foreach($sent_types as $sent_type)
                                                                <option
                                                                    value="{{$sent_type->id}}" {{ $item->question2_note == $sent_type->id ? "selected" : "" }} >{{$sent_type->name}}</option>
                                                            @endforeach
                                                        </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                class="form-control {{($errors->first('question3') ? " form-error" : "")}}"
                                                name="question3" id="question3">
                                                <option value="">اختر</option>
                                                <option {{ $item->question3 == 1 ? "selected" : "" }} value="1">مطابق
                                                    بشكل كلي
                                                </option>
                                                <option {{ $item->question3 == 2 ? "selected" : "" }} value="2">مطابق
                                                    بشكل جزئي
                                                </option>
                                                <option {{ $item->question3 == 3 ? "selected" : "" }} value="3">غير
                                                    مطابق
                                                </option>
                                            </select>
                                            ...
                                            <div style="display: none;" id="question3_note">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input style="width: 75%;" type="text"
                                                               class="col-sm-9 form-control {{($errors->first('question3_note') ? " form-error" : "")}}"
                                                               value="{{ $item->question3_note }}" name="question3_note"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                class="form-control {{($errors->first('question4') ? " form-error" : "")}}"
                                                name="question4" id="question4">
                                                <option value="">اختر</option>
                                                <option {{ $item->question4 == 1 ? "selected" : "" }} value="1">مطابق
                                                </option>
                                                <option {{ $item->question4 == 2 ? "selected" : "" }} value="2">غير
                                                    مطابق
                                                </option>
                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <label class="col-form-label col-sm-3"
                                                            ...
                                                            التوضيح:</label>
                                                        <input style="width: 75%;" type="text"
                                                               class="col-sm-9 form-control {{($errors->first('question4_note') ? " form-error" : "")}}"
                                                               value="{{ $item->question4_note}}" name="question4_note"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                class="form-control {{($errors->first('question5') ? " form-error" : "")}}"
                                                name="question5" id="question5">
                                                <option value="">اختر</option>
                                                <option {{ $item->question5 == 1 ? "selected" : "" }} value="1">مطابق
                                                </option>
                                                <option {{ $item->question5 == 2 ? "selected" : "" }} value="2">غير
                                                    مطابق
                                                </option>
                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input style="width: 75%;" type="date"
                                                               class="col-sm-9 form-control {{($errors->first('question5_note') ? " form-error" : "")}}"
                                                               value="{{ $item->question5_note}}" name="question5_note"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                class="form-control {{($errors->first('question6') ? " form-error" : "")}}"
                                                name="question6" id="question6">
                                                <option value="">اختر</option>
                                                <option {{ $item->question6 == 1 ? "selected" : "" }} value="1">مطابق
                                                    بشكل كلي
                                                </option>
                                                <option {{ $item->question6 == 2 ? "selected" : "" }} value="2">مطابق
                                                    بشكل جزئي
                                                </option>
                                                <option {{ $item->question6 == 3 ? "selected" : "" }} value="3">غير
                                                    مطابق
                                                </option>
                                            </select>
                                            ...
                                            <div style="display: none;" id="question6_note">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input style="width: 75%;" type="date"
                                                               class="col-sm-9 form-control {{($errors->first('question6_note') ? " form-error" : "")}}"
                                                               value="{{ $item->question6_note }}" name="question6_note"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                class="form-control {{($errors->first('question7') ? " form-error" : "")}}"
                                                name="question7" id="question7">
                                                <option value="">اختر</option>
                                                <option {{ $item->question7 == 1 ? "selected" : "" }} value="1">مطابق
                                                </option>
                                                <option {{ $item->question7 == 2 ? "selected" : "" }} value="2">غير
                                                    مطابق
                                                </option>
                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <label class="col-form-label col-sm-6"
                                                            ...
                                                            هي القناة التي قمت من خلالها تقديم الاقتراح/الشكوى؟</label>
                                                        <select style="width: 50%"
                                                                class="form-control  {{($errors->first('question7_note') ? " form-error" : "")}}"
                                                                name="question7_note">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                class="form-control {{($errors->first('question8') ? " form-error" : "")}}"
                                                name="question8" id="question8">
                                                <option value="">اختر</option>
                                                <option {{ $item->question8 == 1 ? "selected" : "" }} value="1">نعم
                                                </option>
                                                <option {{ $item->question8 == 2 ? "selected" : "" }} value="2">لا
                                                </option>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div>
                                                <textarea
                                                    class="form-control {{($errors->first('question9') ? " form-error" : "")}}"
                                                    rows="2" name="question9"
                                                    id="question9">{{ $item->question9 }}</textarea>
