...
{{--                        </button>--}}
                        ...
                        <button type="button" style="width:100px;" class="btn btn-primary adv-search-btn adv-search-btnn"><span
...
{{--                                النظام @else داليا أحمد يونس @endif</td>--}}
                            ...
                            <td style="max-width: 100px;word-break: normal;">     {{  \App\Account::where('id' , $a->deleted_by)->first()->full_name }}</td>
                            <td style="max-width: 100px;word-break: normal;">     {{  \App\Account::where('id' , $a->deleted_by)->first()->circle->name }}</td>
