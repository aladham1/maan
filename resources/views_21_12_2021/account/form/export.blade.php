...
<table style="padding: 10px;border: 1px solid black;border-collapse: collapse;" border="1">
    ...
    @foreach($items as $item)
        <tr>
            ...
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $item->employee_name .'_'. $item->employee_circle}}</td>
            ...
            {{--            @if($a->form_follow && $a->form_follow->solve != 1)--}}
