...
<table style="padding: 10px;border: 1px solid black;border-collapse: collapse;" border="1">
    ...
    @foreach($items as $item)
        <tr>
            ...
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $item->mobile2 ? $item->mobile2 :  $item->citizen->mobile2  }}</td>
            ...
            <?php if($item->project->id != 1 && $item->citizen_projects){
            ...
            <?php }elseif ($item->project->id != 1 && $item->citizen->citizen_projects){
            $xx = $item->citizen->citizen_projects->where('project_id',$item->project->id)->first();
            ?>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">{{ $xx->project_request ?  $xx->project_request : '_' }}</td>
            <?php }else{?>
