                            ...
                            <div class="col-lg-8 col-12 d-flex justify-content-between flex-column mt-1">
                                <div>
                                    <h4 class="page-title text-bold-500 mb-25">
                                        هذه الواجهة مخصصة للتحكم في إدارة تقارير الاقتراحات والشكاوى المسجلة في النظام
                                    </h4>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <form>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3 adv-search"
                                                    ...
                                                    <select class="form-control" name="governorate">
                                                        ...
                                                        <option value="غزة" {{old('governorate')=='غزة'?"selected":""}}>
                                                            غزة
                                                        </option>
                                                        <option
                                                        ...
                                                        <option value="رفح" {{old('governorate')=='رفح'?"selected":""}}>
                                                            رفح
                                                        </option>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="form-group row" align="left">
                                        <div class="col-sm-12">
                                            <button type="submit" target="_blank" name="theaction" title="تصدير إكسل" id="excel_b"
