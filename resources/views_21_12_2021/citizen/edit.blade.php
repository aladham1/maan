...
<section class="container-fluid login-wrap edit-wrap">
    <div class="row">
        <div class="col-md-12">
            @if($project_id != 1)
                <h1 class="inner-h1 wow bounceIn"> أهلاً بك عزيزي {{$citizen["full_name"]}}</h1>
            </div>
            @else
            <div class="col-md-12">
                <h1 class="inner-h1 wow bounceIn"> أهلاً بك عزيزي المواطن</h1>
            </div>
            @endif
        @if($type == 1)
        <div class="col-md-12">
        ...
        @else
        <div class="col-md-12">
                <h5 class="inner-h5">نسعد باستقبال مقترحاتكم بما يساهم في تحسين الخدمات التي يقدمها المركز، يرجى التفضل بتوضيح مقترحاتكم</h5>
        </div>
        @endif
        <hr>
    <div class="container" style="" id="app">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <br>
                            <h4 class="inner-h4"><b>أولاً: معلوماتك الأساسية:</b>
                            </h4>
                            <form method="POST" class="form-horizontal" id="form1" action="/citizen/saveolde/{{$citizen['id']}}" autocomplete="off">
                            @method('patch')
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 mb-10">
                                    ...
                                    <input class="form-control {{($errors->first('mobile') ? " form-error" : "")}}"  type="tel" maxlength="10" onchange="phonenumber($(this).val(),1)" value="{{$citizen["mobile"]}}" id="mobile" name="mobile" autocomplete="mobile">
                                ...
                                <div class="col-md-3 mb-10">
                                    ...
                                    <input class="form-control {{($errors->first('mobile2') ? " form-error" : "")}}" type="tel"
                                            value="{{$citizen["mobile2"]}}" maxlength="10" id="mobile2" name="mobile2" onchange="phonenumber($(this).val(),2)" autocomplete="mobile2">
                                ...
                                <div class="col-md-3 mb-10">
                                    ...
                                    <input class="form-control {{($errors->first('city') ? " form-error" : "")}}" type="text"  value="{{$citizen["city"]}}" id="city" name="city" autocomplete="address">
                                ...
                                <div class="col-md-3 mb-10">
                                    ...
                                    <input class="form-control {{($errors->first('street') ? " form-error" : "")}}" type="text"  value="{{$citizen["street"]}}" id="street" name="street" autocomplete="street">
                                ...
                                <div class="col-md-3 mb-10">
                                    ...
                                    <input name="project_name" value="{{$project_name}}" type="text" readonly class="form-control" >
                                </div>
                            </div>
                        </form>
                    </div>
...
{{--                                                @endif--}}
                                ...
                                <div class="form-group row" id="type_of_box_div" style="display: none !important;">
                                    <div class="col-md-4">
                                        <label for="box_place"  class="col-form-label">مكان تواجد الصندوق</label>
                                    ...
                                    <div class="col-md-4">
                                        <label for="number_of_open_box"  class="col-form-label">رقم اجتماع فتح الصندوق</label>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" name="date_open_box"  value="{{old('date_open_box')}}" />
                                        {!! $errors->first('date_open_box', '<p class="help-block" style="color:red;">:message</p>') !!}
                                    </div>
                                </div>

                                <div class="form-group row column-flex" id="type_of_followup_visit_div" style="display: none !important;">
                                    <div class="col-md-4">
                                        <label for="type_of_followup_visit"  class="col-form-label">نوع زيارة  المتابعة</label>
                                ...
                                <div class="form-group row column-flex">
                                    <div class="col-md-4">
                                        <label for="datee"  class="col-form-label">تاريخ تقديم ال{{$form_type->find($type)->name}} </label>
                            ...
                            <div class="form-group row column-flex">
                                <div class="col-md-4">
                                    <label for="title"  class="col-form-label">موضوع ال{{$form_type->find($type)->name}}</label>
                            ...
                            <div class="form-group row column-flex">
                                <div class="col-md-4">
                                    <label for="content"  class="col-form-label">محتوى ال{{$form_type->find($type)->name}}</label>
                 ...
                 <div class="form-group row" align="left" style="text-align: left;">
            <div class="col-sm-12">
                <button type="submit" id="submitBtn" class="wow bounceIn btn btn-info btn-md" style="background-color:#BE2D45;border:0;">إرسال {{$form_type->find($type)->name}}</button>
            </div>
        </div>
