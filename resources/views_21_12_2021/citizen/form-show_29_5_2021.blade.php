...
@if($auth_circle_users)
    @foreach($auth_circle_users as $AccountProjects_user)
        @if($AccountProjects_user == auth()->user()->account->id)
            ...
            <div class="row">
                <div class="col-md-4">
                    <label class="col-form-label">المدة الزمنية الماضية من معالجة ال{{$form_type->find($type)->name}}</label>
                    <button id="count-days" class="btn btn-primary"></button>
                </div>
                <div class="col-md-6">
                    <label class="col-form-label">المدة الزمنية المطلوبة لمعالجة ال{{$form_type->find($type)->name}}</label>
            ...
            <div class="panel" id="explain_div">
                ...
                <form id="update_clarification_form_modal">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-2">
                            <button id="submit_update_clarification" class="btn btn-primary button">حفظ</button>
                            <button onclick="location.reload();"  class="btn btn-danger button">إلغاء الأمر</button>
                        </div>
                    </div>
            </form>
                @else
        ...
        {{-------------------------------------------------------}}
        @if(!$item->reason_lack_clarification)
                ...
                <form id="delete_form_modal">
                    ...
                    <div class="form-group row">
                        <div style="float:left; margin-left: 50px;">
                            <button id="submit_delete" class="btn btn-primary button">حفظ</button>
                            <button onclick="location.reload();"  class="btn btn-danger button">إلغاء الأمر</button>
                        </div>
                    </div>
                </form>
            ...
            @else
                <form id="update_category_form_modal">
                    ...
                    <div class="form-group row" id="updated_category_div">
                        <div class="col-sm-2">
                            <button id="submit_update_categpry" class="btn btn-primary">حفظ</button>
                            <button onclick="location.reload();"  class="btn btn-danger">إلغاء الأمر</button>
                        </div>
                        <div class="col-sm-10">
        ...
        <button class="accordion hide_div">
              سادساً: إجراءات الرد على ال{{$form_type->find($type)->name}}
        </button>
        <div class="panel hide_div" id="replies">
            ...
            <form action="{{route('change_response_and_update_form_data' , $item->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <select name="required_respond" class="form-control" style=" width: 50%;">
                                ...
                                <option value="عقد زيارة ميدانية/فنية">عقد زيارة ميدانية/فنية</option>
                                <option value="نقاش من خلال لجنة الاقتراحات والشكاوى الخاصة بالمشروع">نقاش من خلال لجنة الاقتراحات والشكاوى الخاصة بالمشروع</option>
                                <option value="نقاش مع الجهات الشريكة/الممولة لمعالجتها ">نقاش مع الجهات الشريكة/الممولة لمعالجتها
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                    <label for="sent_type" class="col-sm-4 col-form-label">الجهة المختصة بالمعالجة</label>
            ...
            @else
                ...
                <div id="replay_advanced" style="@if(!$item->required_respond)display: none @endif">
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <select name="required_respond" class="form-control" style=" width: 50%;" readonly="">
                                <option value="">اختر الإجراء المطلوب</option>
                                <option @if($item->required_respond=="عقد زيارة ميدانية/فنية")selected @endif  value="عقد زيارة ميدانية/فنية"> عقد زيارة ميدانية/فنية</option>
                                <option @if($item->required_respond=="نقاش من خلال لجنة الاقتراحات والشكاوى الخاصة بالمشروع")selected @endif  value="نقاش من خلال لجنة الاقتراحات والشكاوى الخاصة بالمشروع">نقاش من خلال لجنة الاقتراحات والشكاوى الخاصة بالمشروع</option>
                                <option @if($item->required_respond=="نقاش مع الجهات الشريكة/الممولة لمعالجتها")selected @endif value="نقاش مع الجهات الشريكة/الممولة لمعالجتها">نقاش مع الجهات الشريكة/الممولة لمعالجتها
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <label for="response_type" class="col-sm-4 col-form-label">تاريخ تنفيذ الإجراء</label>
                            <input style=" width: 50%;" type="date" value="{{$item->form_data}}" class="form-control" readonly name="form_data"
                                   placeholder="يوم / شهر / سنة"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <label for="response_type" class="col-sm-4 col-form-label">رفع ملف توثيق الإجراء</label>

                            <a style="width: 50%;" target="_blank" class="btn btn-primary"  href="{{ route('downloadfiles', $item->id) }}" >رفع ملف توثيق الإجراء</a>
                        </div>
                    </div>
        ...
        @if($item->form_response && $item->form_response->objection_response)
            <button class="accordion hide_div">
...
@foreach($auth_circle_users2 as $AccountProjects_user)
    @if($AccountProjects_user == auth()->user()->account->id)
            ...
            <div class="row" style="" id="auth_circle_users2">
                <div>
                    ...
                    @if($item->reprocessing_form_id)
                        <div class="row">
                            <div class="col-md-6 col-md-offset-6">
                                <a target="_blank" class="btn btn-primary" href="/citizen/form/reprocessing_show/{{$item->citizen->id_number}}/{{$item->reprocessing_form_id}}">الذهاب لإعادة المعالجة</a>
                            </div>
                        </div>
                        <br><br>
                    @endif
                    ...
                    @if($item->reprocessing_parent_form_id)
                        <div class="row">
                            <div class="col-md-6 col-md-offset-6">
                                <a target="_blank" class="btn btn-primary" href="/citizen/form/show/{{$item->citizen->id_number}}/{{$item->reprocessing_parent_form_id}}">نتيجة المعالجة السابقة</a>
                            </div>
                        </div>
                        <br><br>
                    @endif
        ...
        @if($item->status == 1)
            @if(($item->delay == 1 && $item->response_type == 1 && \Carbon\Carbon::now() > $item->created_at->addDays(18))
                || ($item->delay == 1 &&  \Carbon\Carbon::now() > $item->created_at->addDays(14))
                || ($item->response_type == 1 && \Carbon\Carbon::now() > $item->created_at->addDays(11))
                || (\Carbon\Carbon::now() > $item->created_at->addDays(9)))
       ...
       @if($item->need_clarification)
        ...
        @if($item->confirm_deleting && !$item->recommendations_for_deleting)
            ...
            @if($item->deleted_at || $item->confirm_deleting)
                ...
                @if($item->confirm_deleting && !$item->recommendations_for_deleting)
                    ...
                    <div class="form-group row">
                        <div style="float:left; margin-left: 50px;">
                            <button id="submit_delete" class="btn btn-danger button">حفظ</button>
                        </div>
                    </div>
        ...
        @else
            <button class="accordion1" id="deleted">
                رابعاً: الحاجة لحذف ال{{$form_type->find($type)->name}}
            </button>
            <div class="panel hide_div"></div>
        @endif
        ...
        @if($item->form_response)
            <button class="accordion hide_div">
                {{$form_type->find($type)->name}}سادساً: إجراءات الرد على ال
            </button>
            <div class="panel hide_div" id="replies">
                    <br>
                    @if(($item->response_type == 0 || $item->response_type == 1) && $item->form_response)
                ...
                @if($item->form_response)
                    ...
                    <div class="panel hide_div">
                        ...
                        @if(($item->response_type == 0 || $item->response_type == 1) && $item->form_response)
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label for="sent_type" class="col-sm-4 col-form-label">حالة ال{{$item->form_type->name}}</label>
                                    <?php
                                    if ($item->status == 1) {
                                        $replay_status = "قيد الدراسة";
                                    } elseif ($item->status == 2) {
...
@section('js')
    ...
    <script>
        ...
        var date2 = new Date(<?php $item->created_at;?>);
        $('#count-days').text(calcBusinessDays(date1, date2)+'  يوم');
    </script>
...
<script>
    ...
    $('#update_clarification_form_modal').submit(function (e) {
        ...
        if (!$("input[name='optradio1']:checked").val()) {
            $("#optradio1").addClass('form-error');
            $("#optradio1p").text('يرجى تحديد ما إذا كان <?php echo $form_type->find($type)->name;?> بحاجة لاستيضاح أم لا');
            return;
        }else{
            $("#optradio1p").hide();
        }
        ...
        if($("input[name='optradio1']:checked").val() == 1){
            if (!$("input[name='optradio2']:checked").val()) {
                $("#optradio2").addClass('form-error');
                $("#optradio2p").text('يرجى تحديد نتيجة الاستيضاح عن المعلومات المطلوبة في <?php echo $form_type->find($type)->name; ?>');
                return;
            }else{
                $("#optradio2p").hide();
            }
        ...
        if($("input[name='optradio2']:checked").val() == 1){
            if(!$('#reformulate_content').val()){
                $("#reformulate_content").addClass('form-error');
                $("#optradio3p").text('إعادة صياغة المحتوى غير مدخلة، يرجى إدخال المحتوى بالشكل الصحيح');
                return;
            }else{
                $("#optradio3p").hide();
            }
        ...
        if($("input[name='optradio2']:checked").val() == 0){
            if(!$('#reason_lack_clarification').val()){
                $("#reason_lack_clarification").addClass('form-error');
                $("#optradio4p").text('سبب عدم الاستيضاح غير مدخل، يرجى إدخال السبب بالشكل الصحيح');
                return;
            }else{
                $("#optradio4p").hide();
            }
