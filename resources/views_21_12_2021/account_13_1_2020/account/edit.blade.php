    ...
    <form method="post" enctype="multipart/form-data" action="/account/account/{{$item['id']}}">
        ...
        <div class="form-group row">
            <div class="col-sm-5">
                ...
                <input class="form-control {{($errors->first('full_name') ? " form-error" : "")}}" type="text" value="{{$item["full_name"]}}" id="full_name" name="full_name">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                ...
                <input class="form-control {{($errors->first('mobile') ? " form-error" : "")}}" type="text" placeholder="يجب ان يكون رقم الهاتف 10 أرقام" value="{{$item["mobile"]}}" id="mobile" name="mobile">
