        ...
        <div class="col-sm-3"></div>
            ...
            <div class="col-sm-6">
                <button style="width:60%; background-color:#BE2D45;"
                        type="submit" class="btn btn-info wow bounceIn">انتقل إلى تقديم اقتراحك أو شكواك
                </button>
            </div>
        <div class="col-sm-3"></div>
    </div>
