...
@endsection
<?php $step_for_category = 0;
if($auth_circle_users && in_array(2,$auth_circle_users)){
    $step_for_category = 1;
}?>
@if(Auth::user())
...
//location.reload();
                ...
                $('#update_category_form_modal').submit(function (e) {
                    ...
                    $.post("/account/form/change-category/" + id, {
                        ...
                        var step = 3;
                        var step_for_category = <?php echo $step_for_category; ?>
                        if ($("input[name='optradio4']:checked").val() == 0 || step_for_category == 1) {
                            step = 4;
                        }
                        var url = window.location.href.split('?')[0];
                        if (url.indexOf('?') > -1) {
