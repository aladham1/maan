        ...
        <div>
            ...
            <div class="panel" id="explain_div">
                ...
                <form id="update_clarification_form_modal">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="optradio1"
                                               value="1" @if($item->need_clarification) {{"checked disabled"}} @endif>
                                        نعم
                                    </label>
                                </div>
                            </div>
                    ...
                    <div id="explain_main_div" style="display: none;">
                        ...
                        @if($item->reprocessing && ($item->reprocessing == 0 || $item->reprocessing == 1 ))
                                <hr>
                            <div class="row">
            ...
            <div class="panel hide_div" id="replies">
                ...
                <form action="{{route('change_response_and_update_form_data' , $item->id)}}" method="POST">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <label for="response_type" class="col-sm-4 col-form-label">التصنيف بناءً على الإجراءات
                                المطلوبة:</label>
                    ...
                    @if($item->type=='1')
                        ...
                        &&
                            ...
                            <form method="post" action="/account/form/addreplay/{{$item->id}}">
                                @csrf
                                <textarea name="response" rows="8" cols="105"
                                          style="border-radius: 10px;"></textarea><br>
                                <input type="submit" class="btn btn-info"
                                       style="width: 70%; background-color:#BE2D45; margin-bottom:10px;border:none;"
                                       value="إرسال الرد">
                            </form>
                        @endif
                                    ...
                                    <div style="direction:rtl;text-align:right;#565656">
                                        @if($my_opject['comment']->solve == "1")
                                            ...
                                            @if($my_opject['comment']->evaluate)
                                                ...
                                                كبير @elseif($my_opject['comment']->evaluate == 2) راضي بشكل متوسط @else
                                                    راضي بشكل
                                                    قليل @endif
                                            @endif
                                        @else
                    ...
                    <!--!(!(\App\Form::find($item->id)->form_follow->where('solve',"!=",null)->first())) ||-->
                        ...
                        @else
                            ...
                            <form action="/forms/addevaluate" method="post">
                                ...
                                <br><br>
                                <input id="inp3" style="margin-top:0;" class="fadeOut " name="solve" type="radio"
                                       value="2">لا
                        ...
                        <div class="form-group row">
                            ...
                            @if($item->evaluate)
                                @if($item->evaluate == 1)
                                    ...
                                    <br>
                                    @if(Auth::user())
                                        @if(Auth::user()->account->circle->circle_categories->where('category_id',$item->category->id)->first()
                                            &&
                                            Auth::user()->account->account_projects->where('project_id',$item->project->id)->first()
            ...
            <div class="panel hide_div">
                ...
                @if($recomendations)
                    <div class="content">
                        <h5>{{$recomendations->recommendations_content}}</h5>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <div style=" margin-bottom: 15px;padding: 5px">
                    ...
                    <a href="/account/form" class="btn btn-danger ">إلغاء الأمر &times; </a>
                </div>
            </div>
        </div>
    </div>
