...
@section("content")
    <div class="row">
        ...
        <div class="col-md-2">
            @if(check_permission('إضافة مشروع جديد'))
    ...
    <div class="form-group row" style="padding-right:20px;">
        <form autocomplete="off">
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <button type="submit" target="_blank" name="theaction" title="تصدير إكسل" style="width:100px;"
                            value="excel" class="btn btn-primary" id="excel_b">
            ...
            <div class="row">
                <div class="col-sm-3 col-sm-offset-9  adv-searchh">
                    <button type="submit" name="theaction" title="بحث" style="width:110px;margin-top: 24px;float: left"
                        ...
                        <tr>
                            ...
                            <td style="max-width: 350px;padding-right:50px;">
                                ...
                                @if(check_permission('توظيف'))
                                    <a class="btn btn-xs btn-danger" href="/account/project/stuffinproject/{{$a->id}}">توظيف</a>
                                @endif
                                @if(check_permission(' تبويب الاقتراحات والشكاوى'))
                                    <a class="btn btn-xs btn-danger" href="/account/project/forminproject/{{$a->id}}">الاقتراحات/الشكاوى</a>
                                @endif
