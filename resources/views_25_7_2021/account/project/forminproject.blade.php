 ...
 <form autocomplete="off">
     <div class="form-group row">
         <div class="col-sm-4">
             ...
             <button type="submit" target="_blank" name="theaction" title ="تصدير إكسل" style="width:110px;" value="excel"
                     class="btn btn-primary" id="excel_b">
    ...
    <div class="form-group row">
            <div class="col-sm-3 adv-searchh">
                <input type="text" class="form-control" name="formid" value="{{old('formid')}}" placeholder="الرقم المرجعي"/>
            </div>
        ...
        <div class="col-sm-3 col-md-offset-9 adv-searchh" style="text-align: left;">
