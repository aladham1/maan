        ...
        <div class="col-sm-12">
            <form method="post" action="/account/events" autocomplete="off">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control datepicker {{($errors->first('start_date') ? " form-error" : "")}}" value="" id="start_date" name="start_date" autocomplete="off" placeholder="يوم / شهر / سنة">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control datepicker {{($errors->first('end_date') ? " form-error" : "")}}" value="" id="end_date" name="end_date" placeholder="يوم / شهر / سنة" autocomplete="off">
