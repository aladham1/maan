                ...
                <tbody>
                    @foreach($items as $k=>$a)
                        ...
                        <tr >
                            ...
                            <th style="word-break: normal;">
                                <input type="checkbox" class="checkbox_name" checked name="mobile[]" value="{{$a->citizen->mobile}}" readonly>
            ...
            <tr>
                ...
                <td>
                    <select id="message_type_id" name="message_type_id" class="form-control">
                        ...
                        <option value="{{$sms->first()->message_type->id}}" selected> {{$sms->first()->message_type->name}} </option>
                    </select>
                </td>
                <td>إجمالي عدد الرسائل:</td>
                <td><label id="count_of_messages">{{($sms->first()->message_type->count_of_letter)*($sms->count())}}</label></td>
            </tr>
        </table>
        <br>
