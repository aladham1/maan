...
<table style="padding: 10px;border: 1px solid black;border-collapse: collapse;" border="1">
    ...
    <tr>
        ...
        <th style="text-align: center;vertical-align:center;background-color: #b4c6e7;;height: 20px;padding: 10px;border: 1px solid black;border-collapse: collapse;">رقم الطلب المشروع</th>
        <th style="text-align: center;vertical-align:center;background-color: #b4c6e7;;height: 20px;padding: 10px;border: 1px solid black;border-collapse: collapse;"> عدد الاقتراحات التي تقدم بها المستفيد</th>
        <th style="text-align: center;vertical-align:center;background-color: #b4c6e7;;height: 20px;padding: 10px;border: 1px solid black;border-collapse: collapse;">عدد الشكاوى التي تقدم بها المستفيد</th>
    ...
    @foreach($items as $item)
        ...
        <tr>
            ...
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->mobile2 ? $item->mobile2 : '-'}}</td>
            ...
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;">{{!$item->citizeninproject_id ? $item->name : $item->citizeninproject_name }}</td>
            <td style="text-align: center;padding: 10px;border: 1px solid black;border-collapse: collapse;">{{$item->project_request ? $item->project_request : '-'}}</td>
