...
@section("content")
    ...
    <div class="row">
        <div class="col-md-12">
            <h4>هذه الواجهة مخصصة لتعريف المشاريع التى يعمل عليها المستخدم  {{$item->full_name}} </h4>
        </div>
    </div>
    <br>
        ...
        <div class="col-md-12">
            <form class="form-inline">
                ...
                <div class="form-group adv-searchh" style="margin-top:10px;margin-left: 20px;">
                    ...
                    <input style="width: 230px;" type="date" class="form-control" name="from_date" value="{{request('from_date')}}"
                ...
                <div class="form-group adv-searchh" style="margin-top:10px;margin-left: 20px;">
                    ...
                    <input style="width: 230px;" type="date" class="form-control" name="to_date" value="{{request('to_date')}}"
                           placeholder="يوم / شهر / سنة"/>
                </div>
