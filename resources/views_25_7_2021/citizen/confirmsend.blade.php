    ...
    <div id="boxes">
        <div style="top: 199.5px; left: 551.5px; display: none;color:#af0922;" id="dialog" class="window">
            <img width="15%" src="{{asset("/green.png")}}">
                 ...
                 <h3 style="font-weight:600;">لقد تم اضافة {{$formtype}} بنجاح. </h3>

                <h6 style="font-size:18px;"> الرقم المرجعي ل{{$formtype}} هو  : {{$form->id}}</h6>
            <h6 style="font-size:18px;">يجب الاحتفاظ به لاستعماله في متابعة الرد على {{$formtype}}.</h6>
