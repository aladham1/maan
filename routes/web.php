...
Route::get('/login', function () {
    $itemco=\App\Company::all()->first();
    return view('login',compact('itemco'));
});

Route::get('/forget', function () {
    $itemco=\App\Company::all()->first();
    return view('forget',compact('itemco'));
});
...
Route::post('/account/system/store_followup_post_system',function (){$itemco=\App\Company::all()->first(); return view('welcome',compact('itemco')); });
...
Route::get('/account/system',function (){$itemco=\App\Company::all()->first();return view('welcome',compact('itemco'));});
Route::get('/account/system/accuracy',function (){$itemco=\App\Company::all()->first();return view('welcome',compact('itemco'));});
...
Route::get('/account/system','Account\SystemController@index');
Route::post('/account/system/delete','Account\SystemController@destroy')->name('delete_followup_post_system');
Route::get('/account/system/create/{id}','Account\SystemController@create');
Route::get('/account/system/edit/{id}','Account\SystemController@edit');
Route::post('/account/system/store_followup_post_system','Account\SystemController@store_followup_post_system')->name('store_followup_post_system');
Route::post('/account/system/update_followup_post_system/{id}','Account\SystemController@update_followup_post_system')->name('update_followup_post_system');


Route::get('account/system/accuracy','Account\SystemController@accuracy');
Route::post('/account/system/delete1','Account\SystemController@destroy1')->name('delete_accuracy_system');
Route::get('/account/system/create1/{id}','Account\SystemController@create1');
Route::get('/account/system/edit1/{id}','Account\SystemController@edit1');
Route::post('/account/system/store_accuracy_system','Account\SystemController@store_accuracy_system')->name('store_accuracy_system');
Route::post('/account/system/update_accuracy_system/{id}','Account\SystemController@update_accuracy_system')->name('update_accuracy_system');
...
Route::get('/account/citizen/delete_not_benefit/{id}','Account\CitizenController@destroy_not_benefit');
...
Route::get("/account/message/send_message_with_confirm/{id}", 'Account\MessageController@send_message_with_confirm');
Route::get("/account/message/confirm_send_message/{id}", 'Account\MessageController@confirm_send_message');
Route::post("/account/message/confirm_send_message_post", 'Account\MessageController@confirm_send_message_post');
...
Route::post("/account/category/updateCategoryCircles/{id}","Account\CategoryController@updateCategoryCircles");
...
Route::post('/account/form/confirm_follow_reason_not','Account\FormController@confirm_follow_reason_not')->name('confirm_follow_reason_not');
Route::post('/account/notifications/make_read','Account\NotificationController@make_read')->name('make_read');
...
Route::post('/account/form/confirm_follow_reason_not_reprocessing_recommendations','Account\FormController@confirm_follow_reason_not_reprocessing_recommendations')->name('confirm_follow_reason_not_reprocessing_recommendations');
...
Route::get("/account/private","Account\FormController@index_private");
...
Route::post('/account/form/confirm_change_replay_status_feedback/{id}','Account\FormController@confirm_change_replay_status_feedback')->name('confirm_change_replay_status_feedback');
...
Route::get('/citizen/form/follow_form/{id}','Citizen\FormController@follow_form');
Route::get('/citizen/form/reprocessing_show/{ido}/{id}','Citizen\FormController@reprocessing_show');
...
Route::get('/account/citizen/showprojects/{id}','Account\CitizenController@showprojects')->name('showprojects');
...
Route::get('/citizen/private_info/{type}','Citizen\CitizenController@private_info');
Route::get('/citizen/showdate','Citizen\CitizenController@showdate');
Route::get('/citizen/getproject','Citizen\CitizenController@gethisproject');
Route::get('/citizen/getprojectprivate','Citizen\CitizenController@gethisprojectprivate');
Route::get('/citizen/editorcreatcitizen','Citizen\CitizenController@editorcreatcitizen');
Route::get('/citizen/createcitizenprivate','Citizen\CitizenController@createcitizenprivate');
