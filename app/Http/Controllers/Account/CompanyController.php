...
//            $fileName = time().'.'.$request->steps_file->extension();
            $name = "نظام مركز معاً لإدارة الاقتراحات والشكاوى ملحق رقم (8) ملف الإرشادات العامة";
            $fileName = $name.'.'.$request->steps_file->extension();
...
//        return redirect('/account');
        return redirect('/account/company/'.$id.'/edit');
    }
