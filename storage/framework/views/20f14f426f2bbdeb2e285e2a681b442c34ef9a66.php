<?php $__env->startSection("title", "تعديل بيانات حساب موظف $item->full_name"); ?>
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-content">
                ...
                <div class="card-body">
    <form method="post" enctype="multipart/form-data" action="/account/account/<?php echo e($item['id']); ?>">
        ...
        <div class="form-group row">
            <div class="col-sm-4">
                ...
                <input class="form-control <?php echo e(($errors->first('user_name') ? " form-error" : "")); ?>" type="text" value="<?php echo e($item["user_name"]); ?>" id="user_name" name="user_name">
                <input class="form-control" type="hidden" value="<?php echo e($item["full_name"]); ?>" id="full_name" name="full_name">
            ...
            <div class="col-sm-4">
                ...
                <input class="form-control <?php echo e(($errors->first('id_number') ? " form-error" : "")); ?>" type="text" value="<?php echo e($item["id_number"]); ?>" id="id_number" name="id_number">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                ...
                <input class="form-control <?php echo e(($errors->first('mobile') ? " form-error" : "")); ?>" type="text" placeholder="" value="<?php echo e($item["mobile"]); ?>" id="mobile" name="mobile">
            ...
            <div class="col-sm-4">
                ...
                <input class="form-control <?php echo e(($errors->first('email') ? " form-error" : "")); ?>" type="email" value="<?php echo e($item["email"]); ?>" id="email" name="email">
        ...
        <div class="form-group row">
            <div class="col-sm-4">
                ...
                <input class="form-control <?php echo e(($errors->first('password') ? " form-error" : "")); ?>" type="password" value="<?php echo e($item["password"]); ?>" id="password" name="password">
            ...
            <div class="col-sm-4">
                ...
                <select class="form-control <?php echo e(($errors->first('circle_id') ? " form-error" : "")); ?>" name="circle_id">
                    ...
                    <?php $__currentLoopData = $circles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $circle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($circle -> id); ?>" <?php echo e($item['circle_id']==$circle -> id?"selected":""); ?>><?php echo e($circle -> name); ?></option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <select
                    ...
                    name="private">
                    <option value="">اختر</option>
                    <option value="1" <?php echo e($item['private'] == 1 ?"selected":""); ?>>نعم</option>
                    <option value="0" <?php echo e($item['private'] == 0 ?"selected":""); ?>>لا</option>
                </select>
            </div>
