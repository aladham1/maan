                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        <label for="code" class="col-form-label">رمز المشروع</label>
                            <input type="text" class="form-control" value="<?php echo e(old('code')); ?>" id="code" name="code">
                    ...
                    <div class="col-sm-4">
                        <label for="name" class="col-form-label">اسم المشروع بالعربية</label>
                         <input type="text" autofocus class="form-control" value="<?php echo e(old('name')); ?>" id="name" name="name">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        <label for="start_date" class="col-form-label"> تاريخ بداية المشروع</label>
                          <input type="date" class="form-control" value="<?php echo e(old('start_date')); ?>" id="start_date" name="start_date" placeholder="يوم / شهر / سنة">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="date" class="form-control" value="<?php echo e(old('end_date')); ?>" id="end_date" name="end_date" placeholder="يوم / شهر / سنة">
