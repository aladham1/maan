<?php $__env->startSection("title", "متابعة نشر إجراءات النظام"); ?>
                            ...
                            <div class="col-lg-8 col-12 d-flex justify-content-between flex-column mt-1">
                                <div>
                                    <h4 class="page-title text-bold-500 mb-25">
                                        هذه الواجهة مخصصة للتحكم في متابعة نشر إجراءات نظام الاقتراحات والشكاوى للفئات
                                        المستهدفة في مشاريع المركز.
                                    </h4>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-3 adv-search">
                                        <input type="text" class="form-control" name="project_request" placeholder="رقم طلب المشروع">
                                    </div>
                                ...
                                <?php if($items->count()>0): ?>
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped"
                                            ...
                                            <thead>
                                            <tr>
                                                <th style="word-break: normal;">رقم طلب المشروع</th>
                                                <th style="max-width: 100px;word-break: normal;">اسم المستفيد</th>
                                            ...
                                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="tr-id-<?php echo e($a->id); ?>">
                                                    <td style="word-break: normal;"><?php echo e($a->project_request); ?></td>
                                                    ...
                                                    <td style="max-width: 150px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">
                                                        <?php if(!$a->followup_post_system_id): ?>
                                                            <a
                                                                target="_blank" title="معاينة" class="btn btn-xs btn-primary"
                                                                href="/account/system/create/<?php echo e($a->citizen_project_id); ?>">
                                                                <i class="glyphicon glyphicon-eye-open"></i>
                                                            </a>
                                                        <?php else: ?>
                                                            <a
                                                                target="_blank" title="معاينة" class="btn btn-xs btn-primary"
                                                                href="/account/system/edit/<?php echo e($a->followup_post_system_id); ?>">
                                                                <i class="glyphicon glyphicon-eye-open"></i>
                                                            </a>
                                                        <?php endif; ?>
                                                        ...
                                                        <a class="btn btn-xs Confirm22 btn-danger" data-id="<?php echo e($a->followup_post_system_id); ?>"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        $(function () {
            ...
            $('#delete_form_modal').submit(function (e) {
                ...
                $.post("<?php echo e(route('delete_followup_post_system')); ?>", {
