<?php $__env->startSection("title", "تعديل الرسائل النصية"); ?>
<?php $__env->startSection("content"); ?>
    ...
    <div class="row">
        ...
        <form method="post" action="/account/message/update/<?php echo e($item->id); ?>" enctype="multipart/form-data" autocomplete="off">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" value="<?php echo e($item->name); ?>" id="name" name="name">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" onkeyup="countChar(this);" value="<?php echo e($item->text); ?>" id="message_text"
                           name="text">
                </div>
    ...
    flex-direction: row;">
                <span style="margin-bottom: 5px;margin-left: 10px;padding:10px;border-radius: 5px;border: 1px solid red;">
                    ...
                    <span id="count_of_letter" style="color:red;" name="count_of_letter"><?php echo e($item->count_of_letter); ?></span>
                ...
                <span style="margin-bottom: 5px;margin-left: 10px;padding:10px;border-radius: 5px;border: 1px solid gray;">
                    ...
                    <span id="charNum" style="color:red;" name="Remaining_letters"><?php echo e($item->Remaining_letters); ?></span>
                ...
                <span style="margin-bottom: 5px;padding:10px;border-radius: 5px;border: 1px solid yellow;">
                    ...
                    <span id="count_of_letters" style="color:red;" name="consumed_letters"><?php echo e($item->consumed_letters); ?></span>
