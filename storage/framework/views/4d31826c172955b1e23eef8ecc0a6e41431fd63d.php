    ...
    <div style="" id="auth_circle_users">
        ...
        <div class="panel" id="first_panel">
            <table class="table table-hover table-striped table-bordered" style="width:100%;white-space:normal;">
                <tr>
                    <td>الرقم المرجعي:</td>
                    <td colspan="3"><?php echo e($item->id); ?></td>
                </tr>
    ...
    <div class="container">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group row">
                                    <div class="col-sm-12" id="stop_div" style="display: none">
                                        <p>سيتم إيقاف ال<?php echo e($form_type->find($type)->name); ?></p>
                                    </div>
                                </div>
        ...
        <div class="panel panel-primary setup-content" id="step-3">
            ...
            <div class="panel-body">
                ...
                <?php if(!is_null($item->old_category_id)): ?>
        ...
        <div class="col-sm-12 text-center">
            <div style=" margin-bottom: 15px;padding: 5px">
                <form style="display:inline"
                      action="/citizen/form/show/<?php echo e($item->citizen->id_number); ?>/<?php echo e($item->id); ?>">
