                                ...
                                <div class="col-md-4">
                                    <div class="form-group adv-searchh">
                                        <select name="private" class="form-control">
                                            <option value="" selected>تعامل المستخدم مع الاقتراحات والشكاوى ذات
                                                الخصوصية
                                            </option>
                                        ...
                                        <div class="table-responsive" style="width:100%">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="max-width:100px;text-overflow: ellipsis;white-space: nowrap;">
                                                        تعامل المستخدم مع الاقتراحات والشكاوى ذات الخصوصية
                                                    </th>
...
<!--                                                        --><?php //$css = "padding-right: 50px;"?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="max-width: 100px;text-overflow: ellipsis;white-space: nowrap;"><?php if($a->private == 1): ?> <?php echo e('نعم'); ?> <?php else: ?> <?php echo e('لا'); ?> <?php endif; ?></td>

                                                        <td style="text-align: center; <?php echo $css; ?> max-width: 300px;text-overflow: ellipsis;white-space: nowrap;">
                                                            <?php if(check_permission_by_id('107')): ?>
                                                                <a class="btn btn-sm green-btn"
                                                                   href="/account/account/forminaccount/<?php echo e($a->id); ?>">الاقتراحات/الشكاوى</a>
                                                            <?php endif; ?>
