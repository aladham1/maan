                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered"
                                                        ...
                                                        <tr class="showdateciz">
                                                            ...
                                                            <td colspan="2"><?php if($item->hide_data == 1 || $item->private_account != Auth::user()->id): ?><?php echo e('_'); ?><?php else: ?> <?php echo e($item->citizen->id); ?><?php endif; ?></td>
                                                            <td colspan="2">الاسم رباعي:</td>
                                                            <td colspan="2"><?php if($item->hide_data == 1 || $item->private_account != Auth::user()->id): ?><?php echo e('_'); ?><?php else: ?><?php echo e($item->citizen->first_name ." ".$item->citizen->father_name." ".$item->citizen->last_name); ?><?php endif; ?></td>
                                                            <td colspan="2">رقم الهوية/جواز السفر:</td>
                                                            <td colspan="2"><?php if($item->hide_data == 1 || $item->private_account != Auth::user()->id): ?><?php echo e('_'); ?><?php else: ?><?php echo e($item->citizen->id_number); ?><?php endif; ?></td>
                                                        </tr>

                                                        <tr class="showdateciz">
                                                            <td colspan="2">رقم التواصل (1):</td>
                                                            <td colspan="2"><?php if($item->hide_data == 1 || $item->private_account != Auth::user()->id): ?><?php echo e('_'); ?><?php else: ?><?php echo e($item->citizen->mobile); ?><?php endif; ?></td>
                                                            <td colspan="2">رقم التواصل (2):</td>
                                                            <td colspan="2"><?php if($item->hide_data == 1 || $item->private_account != Auth::user()->id): ?><?php echo e('_'); ?><?php else: ?><?php echo e($item->citizen->mobile2); ?><?php endif; ?></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php if($item->hide_data == 1 || $item->private_account != Auth::user()->id): ?>
