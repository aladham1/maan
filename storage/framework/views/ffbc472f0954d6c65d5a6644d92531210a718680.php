...
<?php else: ?>
    <?php $__env->startSection("title", "إدارة الاقتراحات والشكاوى ذات الخصوصية"); ?>
<?php endif; ?>
                        ...
                        <div class="col-lg-6 col-12 d-flex justify-content-between flex-column mt-1">
                            <div>
                                <h4 class="page-title text-bold-500 mb-25">
                                    هذه الواجهة مخصصة للتحكم في إدارة الاقتراحات والشكاوى ذات الخصوصية المسجلة في النظام
                                </h4>
                            </div>
                        </div>
                ...
                <table class="table table-hover table-striped"
                    ...
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="tr-id-<?php echo e($a->id); ?>">
                            ...
                            <td style="max-width: 100px;word-break: normal;"><?php echo e($a->project->code); ?></td>
