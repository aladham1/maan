...
<table style="padding: 10px;border: 1px solid black;border-collapse: collapse;" border="1">
    ...
    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <?php $Citizen = \App\Citizen::find($item->citizen_id); ?>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->id); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($Citizen->first_name .' '.$Citizen->father_name .' '.$Citizen->grandfather_name.' '.$Citizen->last_name); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($Citizen->id_number); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($Citizen->governorate); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($Citizen->city); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($Citizen->street); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($Citizen->mobile); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($Citizen->mobile2); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->project->id == 1 ? 'غير مستفيد' : ' مستفيد'); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->project->name); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->project->end_date <= now() ?  'منتهي' : 'مستمر'); ?></td>
                <?php if($item->citizen_projects){
                $xx = $item->citizen_projects->where('project_id',$item->project->id)->first();
                ?>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($xx->project_request); ?></td>
                <?php }else{?>
                ...
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;"><?php echo e($item->box_place); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;"><?php echo e($item->date_open_box); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;"><?php echo e($item->number_of_open_box); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;"><?php echo e($item->type_of_followup_visit); ?></td>
                ...
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->title); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->content); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->account_id); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php if($item->need_clarification == 1): ?><?php echo e('نعم'); ?><?php else: ?><?php echo e('لا'); ?><?php endif; ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php if($item->have_clarified == 1): ?><?php echo e('نعم'); ?><?php else: ?><?php echo e('لا'); ?><?php endif; ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->reason_lack_clarification); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->reformulate_content); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->nammes); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->user_change_content_full_name); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->response_type); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->required_respond); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->replay_status); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->response); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->form_responses_datee); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->user_required_respond_full_name); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->form_status_ttt); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->follow_reason_not); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->follow_datee); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->evaluate); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->form_follow_notes); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->user_reprocessing_recommendations_full_name); ?></td>
                <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php if($item->reprocessing_form_id): ?><?php echo e('نعم'); ?><?php else: ?><?php echo e('لا'); ?><?php endif; ?></td>
        </tr>
