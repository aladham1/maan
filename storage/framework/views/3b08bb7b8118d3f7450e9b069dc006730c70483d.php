	        ...
	        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
               ...
               <table class="table table-hover table-striped table-bordered table-responsive" style="width:100%;white-space:normal;">
                   <tr class="showdateciz">
                       ...
                       <td colspan="2"><?php echo e($item->citizen->first_name ." ".$item->citizen->father_name." ".$item->citizen->last_name); ?></td>
                       <td colspan="2">رقم الهوية/جواز السفر:</td>
                       <td colspan="2"><?php echo e($item->citizen->id_number); ?></td>
                   </tr>

                   <tr class="showdateciz">
                       <td colspan="2">رقم التواصل (1):</td>
                       <td colspan="2"><?php echo e($item->citizen->mobile); ?></td>
                       <td colspan="2">رقم التواصل (2):</td>
                       <td colspan="2"><?php echo e($item->citizen->mobile2); ?></td>
                   ...
                   <tr class="showdateciz">
                       ...
                       ?>
                       <td colspan="2"><?php if(!in_array($item->project->id,$project_arr)): ?><?php echo e('غير مستفيد من مشاريع المركز'); ?><?php else: ?><?php echo e('مستفيد من مشاريع المركز '); ?><?php endif; ?></td>
                   </tr>

                   <tr>
                       <td colspan="2">رقم طلب المشروع:</td>
                       <td colspan="2"><?php if($item->project->id !=1): ?><?php echo e($item->citizen->citizen_project($item->project->id)->project_request); ?><?php else: ?> <?php echo e('_'); ?> <?php endif; ?></td>
