...
<table style="padding: 10px;border: 1px solid black;border-collapse: collapse;" border="1">
 ...
 '.$item->citizen->grandfather_name.' '.$item->citizen->last_name); ?> <?php endif; ?></td>
            ...
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->street ?  $item->street :  $item->citizen->street); ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->mobile ?  $item->mobile :  $item->citizen->mobile); ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;">

                <?php if($item->mobile2): ?>
                    <?php echo e($item->mobile2); ?>

                <?php elseif($item->citizen && $item->citizen->mobile2): ?>
                    <?php echo e($item->citizen->mobile2); ?>
            ...
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->project_request ?  $item->project_request : '_'); ?></td>
            <?php }else{?>
            ...
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->senmmes ? $item->senmmes : $item->sent_typee->name); ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;"><?php echo e($item->box_place ? $item->box_place : '-'); ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;"><?php echo e($item->date_open_box ? $item->date_open_box : '-'); ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;"><?php echo e($item->number_of_open_box ? $item->number_of_open_box : '-'); ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;color: red;"><?php echo e($item->type_of_followup_visit ? $item->type_of_followup_visit : '-'); ?></td>
            ...
            ?>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($user1->name); ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($user2->name); ?></td>
            ...
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php if($item->have_clarified == 1): ?><?php echo e('نعم'); ?><?php else: ?><?php echo e('-'); ?><?php endif; ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->reason_lack_clarification ? $item->reason_lack_clarification : '-'); ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->reformulate_content ? $item->reformulate_content : '-'); ?></td>
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php echo e($item->old_category ? $item->old_category : '-'); ?></td>
            <?php if($item->old_category): ?>
                <?php
                $categoryCircles_users1 = $categoryCircles_users2 = $auth_circle_users = array();
            ...
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php if($item->required_respond): ?> <?php echo e($item->required_respond); ?><?php else: ?> <?php echo e('-'); ?> <?php endif; ?></td>
            ...
            <td style="padding: 10px;border: 1px solid black;border-collapse: collapse;"><?php if(!$item->follower_reprocessing == 1): ?><?php echo e('لا'); ?><?php else: ?><?php echo e('نعم'); ?><?php endif; ?></td>
