<?php $__env->startSection("title", "إضافة متابعة دقة البيانات المسجلة على النظام"); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered"
                                ...
                                <tr>
                                    ...
                                    <td><?php if($item->mobile2): ?><?php echo e($item->mobile2); ?><?php else: ?><?php echo e('-'); ?><?php endif; ?></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 350px;word-break: break-word;"><?php echo e($item->name); ?></td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-bordered" style="text-align:right;white-space:normal;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control <?php echo e(($errors->first('question1') ? " form-error" : "")); ?>" name="question1" id="question1">
                                                ...
                                                <option <?php echo e(old('question1') == 1 ? "selected" : ""); ?> value="1">مطابق</option>
                                                <option <?php echo e(old('question1') == 2 ? "selected" : ""); ?> value="2">غير مطابق</option>
                                            </select>
                                            ...
                                            <div style="display: none;" id="question1_note">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input style="width: 75%;" type="text" class="col-sm-9 form-control <?php echo e(($errors->first('question1_note') ? " form-error" : "")); ?>" value="<?php echo e(old('question1_note')); ?>" name="question1_note" id="question1_note_input" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control <?php echo e(($errors->first('question2') ? " form-error" : "")); ?>" name="question2" id="question2">
                                                <option value="">اختر</option>
                                                <option <?php echo e(old('question2') == 1 ? "selected" : ""); ?> value="1">مطابق</option>
                                                <option <?php echo e(old('question2') == 2 ? "selected" : ""); ?> value="2">غير مطابق</option>
                                            </select>
                                            ...
                                            <div  style="display: none;" id="question2_note">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <select style="width: 50%" class="form-control  <?php echo e(($errors->first('question2_note') ? " form-error" : "")); ?>" name="question2_note">
                                                            <option value="">اختر</option>
                                                            <?php $__currentLoopData = $sent_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sent_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($sent_type->id); ?>" <?php echo e(old('question2_note') == $sent_type->id ? "selected" : ""); ?> ><?php echo e($sent_type->name); ?></option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control <?php echo e(($errors->first('question3') ? " form-error" : "")); ?>" name="question3" id="question3">
                                                <option value="">اختر</option>
                                                <option <?php echo e(old('question3') == 1 ? "selected" : ""); ?> value="1">مطابق بشكل كلي</option>
                                                <option <?php echo e(old('question3') == 2 ? "selected" : ""); ?> value="2">مطابق بشكل جزئي</option>
                                                <option <?php echo e(old('question3') == 3 ? "selected" : ""); ?> value="3">غير مطابق</option>
                                            </select>
                                            ...
                                            <div  style="display: none;" id="question3_note">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input style="width: 75%;" type="text" class="col-sm-9 form-control <?php echo e(($errors->first('question3_note') ? " form-error" : "")); ?>" value="<?php echo e(old('question3_note')); ?>" name="question3_note" id="question3_note_input" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control <?php echo e(($errors->first('question4') ? " form-error" : "")); ?>" name="question4" id="question4">
                                                <option value="">اختر</option>
                                                <option <?php echo e(old('question4') == 1 ? "selected" : ""); ?> value="1">مطابق</option>
                                                <option <?php echo e(old('question4') == 2 ? "selected" : ""); ?> value="2">غير مطابق</option>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control <?php echo e(($errors->first('question5') ? " form-error" : "")); ?>" name="question5" id="question5">
                                                <option value="">اختر</option>
                                                <option <?php echo e(old('question5') == 1 ? "selected" : ""); ?> value="1">مطابق</option>
                                                <option <?php echo e(old('question5') == 2 ? "selected" : ""); ?> value="2">غير مطابق</option>
                                            </select>
                                            ...
                                            <div  style="display: none;" id="question5_note">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input style="width: 75%;" type="date" class="col-sm-9 form-control <?php echo e(($errors->first('question5_note') ? " form-error" : "")); ?>" value="<?php echo e(old('question5_note')); ?>" name="question5_note" id="question5_note_input" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control <?php echo e(($errors->first('question6') ? " form-error" : "")); ?>" name="question6" id="question6">
                                                <option value="">اختر</option>
                                                <option <?php echo e(old('question6') == 1 ? "selected" : ""); ?> value="1">مطابق بشكل كلي</option>
                                                <option <?php echo e(old('question6') == 2 ? "selected" : ""); ?> value="2">مطابق بشكل جزئي</option>
                                                <option <?php echo e(old('question6') == 3 ? "selected" : ""); ?> value="3">غير مطابق</option>
                                            </select>
                                            ...
                                            <div  style="display: none;" id="question6_note">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input style="width: 75%;" type="date" class="col-sm-9 form-control <?php echo e(($errors->first('question6_note') ? " form-error" : "")); ?>" value="<?php echo e(old('question6_note')); ?>" name="question6_note" id="question6_note_input" />
                                    ...
                                    <tr>
                                        ...
                                        <?php endif; ?>
                                        <td>
                                            <select class="form-control <?php echo e(($errors->first('question7') ? " form-error" : "")); ?>" name="question7" id="question7">
                                                <option value="">اختر</option>
                                                <option <?php echo e(old('question7') == 1 ? "selected" : ""); ?> value="1">مطابق</option>
                                                <option <?php echo e(old('question7') == 2 ? "selected" : ""); ?> value="2">غير مطابق</option>
                                            </select>
                                        ...
                                        <td colspan="6">
                                            <div  style="display: none;" id="question7_note">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <label class="col-form-label col-sm-6" style="font-weight: bold;color: red;text-align: right">ما هي القناة التي قمت من خلالها تقديم الاقتراح/الشكوى؟</label>
                                                        <select style="width: 50%" class="form-control  <?php echo e(($errors->first('question7_note') ? " form-error" : "")); ?>" name="question7_note">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control <?php echo e(($errors->first('question8') ? " form-error" : "")); ?>" name="question8" id="question8">
                                                <option value="">اختر</option>
                                                <option <?php echo e(old('question8') == 1 ? "selected" : ""); ?> value="1">نعم</option>
                                                <option <?php echo e(old('question8') == 2 ? "selected" : ""); ?> value="2">لا</option>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div>
                                                <textarea class="form-control <?php echo e(($errors->first('question9') ? " form-error" : "")); ?>" rows="2" name="question9" id="question9"><?php echo e(old('question9')); ?></textarea>
