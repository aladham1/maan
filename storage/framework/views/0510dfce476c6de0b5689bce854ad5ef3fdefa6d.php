...
<?php $__env->startSection("content"); ?>
    ...
    <div class="row">
        <div class="col-md-9">
            <h4>هذه الواجهة مخصصة للتحكم في إدارة الاقتراحات والشكاوى التي تقع ضمن مسؤولية صاحب
                الحساب.</h4>
        </div>
    </div>
    <br>
            ...
            <form>
                ...
                <div class="row">
                    <div class="col-sm-3 adv-search">
                        ...
                        <input type="text" class="form-control datepicker" name="datee" value="<?php echo e(request('datee')); ?>"
                    ...
                    <div class="col-sm-3 adv-search">
                        <button type="submit" name="theaction" title="بحث" style="width:100px;margin-top:25px"
                                value="search"
                                class="btn btn-primary noEnterSubmit"><span class="glyphicon glyphicon-search"
