            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover table-striped"
                    ...
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            <td style="max-width: 100px;word-break: normal;"><?php echo e($a->id); ?></td>
                            <td style="max-width: 300px;word-break: normal;"> <?php if($a->hide_data == 1): ?><?php echo e('_'); ?><?php else: ?><?php echo e($a->citizen->first_name." ".$a->citizen->father_name." ".$a->citizen->grandfather_name." ".$a->citizen->last_name); ?><?php endif; ?></td>
