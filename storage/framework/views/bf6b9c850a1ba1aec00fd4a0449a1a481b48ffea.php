<?php $__env->startSection("title", "فئات الاقتراحات والشكاوى للمستوى الإداري $item->name  "); ?>
...
<?php $__env->startSection("content"); ?>
    ...
    <?php if($items): ?>
        <?php if($items->count()>0): ?>
            <form method="post" action="/account/circle/select-category-post/<?php echo e($item->id); ?>">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="table-responsive" id="editLevelTable2">
                            <table style="width:170% !important;max-width:185% !important;white-space:normal;"
                                ...
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <tr>
                                        <td style="max-width: 100px;word-break: normal;"><?php echo e($i+1); ?></td>
                                        <td colspan="3" style="max-width: 100px;word-break: normal;">
                                            <input type='hidden' name="category_ids[<?php echo e($i); ?>]"
                                                   value="<?php echo e($category->id); ?>" checked>
                                            <?php echo e($category->name); ?>

                                        </td>
                                        <td style="max-width: 100px;word-break: normal;"><?php echo e($category->is_complaint == 1 ?  ' شكوي '  : ' اقتراح '); ?></td>
                                        ...
                                        <?php $__currentLoopData = $procedureTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $procedureType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td style="text-align:center;max-width: 100px;word-break: normal;">
                                                <input type="checkbox" name="category_circle[]"
                                                       value="<?php echo e($procedureType->id.'_'.$item->id); ?>" <?php if(in_array($procedureType->id.'_'.$item->id,$Cat)): ?> <?php echo e('checked'); ?> <?php endif; ?>>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tr>
                                    <?php $i++?>
