                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered"
                                                    ...
                                                    <tr class="showdateciz">
                                                        ...
                                                        <td colspan="2"><?php echo e($forms->first()->citizen->first_name ." ".$forms->first()->citizen->father_name." ".$forms->first()->citizen->last_name); ?></td>
                                                        <td colspan="2">رقم الهوية/جواز السفر:</td>
                                                        <td colspan="2"><?php echo e($forms->first()->citizen->id_number); ?></td>
                                                        <td colspan="2">رقم التواصل (1):</td>
                                                        <td colspan="2"><?php echo e($forms->first()->citizen->mobile); ?></td>
                                                    </tr>

                                                    <tr class="showdateciz">
                                                        <td colspan="2">رقم التواصل (2):</td>
                                                        <td colspan="2"><?php echo e($forms->first()->citizen->mobile2); ?></td>
                                                        <td colspan="2">المحافظة:</td>
                                                        <td colspan="2"><?php echo e($forms->first()->citizen->governorate); ?></td>
                                                        <td colspan="2">المنطقة:</td>
                                                        <td colspan="2"><?php echo e($forms->first()->citizen->city); ?></td>
                                                    </tr>
                                                        ...
                                                        <?php if($forms!=null): ?>
                                                            <?php $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr style="background-color:white">
                                                                    ...
                                                                    <td style="text-align: center;"><?php echo e($form->id); ?></td>
                                                                    <td style="text-align: center;"> <?php echo e($form->project->id == 1 ? 'غير مستفيد' : ' مستفيد'); ?> </td>
                                                                    <td style="text-align: center;"> <?php if($form->project): ?>  <?php echo e($form->project->name); ?> <?php endif; ?> </td>
                                                                    <td style="text-align: center;"><?php echo e($form->form_type->name); ?></td>
                                                                    ...
                                                                    <td style="text-align: center;">
                                                                        <a target="_blank" title="عرض"
                                                                           ...
                                                                           href="/citizen/form/follow_form/<?php echo e($form->id); ?>">
                                                                            عرض
                                                                        </a>
                                                                    </td>
