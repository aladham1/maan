<?php $__env->startSection("title", "تعديل متابعة نشر إجراءات النظام"); ?>
        ...
        <div class="col-md-12 col-12">
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        <form method="post"
                              action="/account/system/update_followup_post_system/<?php echo e($item->followup_post_system_id); ?>"
                              autocomplete="off">
                            <?php echo csrf_field(); ?>
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-bordered"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                ...
                                                <option <?php echo e($item->question1 == 1 ? "selected" : ""); ?> value="1">نعم
                                                </option>
                                                <option <?php echo e($item->question1 == 2 ? "selected" : ""); ?> value="2">لا
                                                </option>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                ...
                                                <option value="">اختر</option>
                                                <option <?php echo e($item->question2 == 1 ? "selected" : ""); ?> value="1">نعم
                                                </option>
                                                <option <?php echo e($item->question2 == 2 ? "selected" : ""); ?> value="2">لا
                                                </option>
                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input style="width: 75%;" type="text"
                                                               class="col-sm-9 form-control <?php echo e(($errors->first('question2_note') ? " form-error" : "")); ?>"
                                                               value="<?php echo e($item->question2_note); ?>" name="question2_note"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                ...
                                                <option value="">اختر</option>
                                                <option <?php echo e($item->question3 == 1 ? "selected" : ""); ?> value="1">نعم
                                                </option>
                                                <option <?php echo e($item->question3 == 2 ? "selected" : ""); ?> value="2">لا
                                                </option>
                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <select style="width: 50%"
                                                                class="form-control  <?php echo e(($errors->first('question3_note') ? " form-error" : "")); ?>"
                                                                name="question3_note">
                                                            <option value="">اختر</option>
                                                            <?php $__currentLoopData = $sent_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sent_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option
                                                                    value="<?php echo e($sent_type->id); ?>" <?php echo e($item->question3_note == $sent_type->id ? "selected" : ""); ?> ><?php echo e($sent_type->name); ?></option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                ...
                                                <option value="">اختر</option>
                                                <option <?php echo e($item->question4 == 1 ? "selected" : ""); ?> value="1">نعم
                                                </option>
                                                <option <?php echo e($item->question4 == 2 ? "selected" : ""); ?> value="2">لا
                                                </option>
                                                <option <?php echo e($item->question4 == 3 ? "selected" : ""); ?> value="3">الصندوق
                                                    غير مفعل في المشروع
                                                </option>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                ...
                                                <option value="">اختر</option>
                                                <option <?php echo e($item->question5 == 1 ? "selected" : ""); ?> value="1">نعم
                                                </option>
                                                <option <?php echo e($item->question5 == 2 ? "selected" : ""); ?> value="2">لا
                                                </option>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select
                                                ...
                                                <option value="">اختر</option>
                                                <option <?php echo e($item->question6 == 1 ? "selected" : ""); ?> value="1">نعم
                                                </option>
                                                <option <?php echo e($item->question6 == 2 ? "selected" : ""); ?> value="2">لا
                                                </option>
                                            </select>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div>
                                                <textarea
                                                    ...
                                                    id="question7"><?php echo e($item->question7); ?></textarea>
